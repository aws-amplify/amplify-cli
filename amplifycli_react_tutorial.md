...
This tutorial walks you through how to use the AWS Amplify CLI with a React application. You can use a similar process with a React Native application (but you omit hosting) or alternative JavaScript frameworks.
