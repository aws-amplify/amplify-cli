...
export function makeModelXFilterInputObject(obj: ObjectTypeDefinitionNode, ctx: TransformerContext): InputObjectTypeDefinitionNode {
...
export function makeEnumFilterInputObjects(obj: ObjectTypeDefinitionNode, ctx: TransformerContext): InputObjectTypeDefinitionNode[] {
  return obj.fields
    ...
    .map((enumField: FieldDefinitionNode) => {
      ...
      const name = isList ? ModelResourceIDs.ModelFilterListInputTypeName(typeName) : ModelResourceIDs.ModelFilterInputTypeName(typeName);
      const fields = [];
...
export function makeModelConnectionField(fieldName: string, returnTypeName: string, sortKeyInfo?: SortKeyFieldInfo): FieldDefinitionNode {
  ...
  return makeField(fieldName, args, makeNamedType(ModelResourceIDs.ModelConnectionTypeName(returnTypeName)));
}
