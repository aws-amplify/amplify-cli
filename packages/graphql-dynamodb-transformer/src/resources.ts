    ...
    public initTemplate(): Template {
        return {
            Parameters: {
                ...
                [ResourceConstants.PARAMETERS.UsePayPerRequestBilling]: new StringParameter({
                    Description: 'Configure @model types to create DynamoDB tables with PER_REQUEST_BILLING enabled.',
                    Default: 'false',
                    AllowedValues: [
                        'true',
                        'false'
            ...
            Conditions: {
                ...
                [ResourceConstants.CONDITIONS.ShouldUsePayPerRequestBilling]:
                    Fn.Equals(Fn.Ref(ResourceConstants.PARAMETERS.UsePayPerRequestBilling), 'true')
            }
        }
    }
