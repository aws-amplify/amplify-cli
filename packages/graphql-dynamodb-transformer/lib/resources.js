...
var ResourceFactory = /** @class */ (function () {
    ...
    ResourceFactory.prototype.makeParams = function () {
        ...
        return _a = {},
            ...
            _a[graphql_transformer_common_1.ResourceConstants.PARAMETERS.DynamoDBModelTableName] = new cloudform_1.StringParameter({
            ...
            _a[graphql_transformer_common_1.ResourceConstants.PARAMETERS.DynamoDBModelTableAccessIAMRoleName] = new cloudform_1.StringParameter({
    ...
    ResourceFactory.prototype.initTemplate = function () {
        ...
        return {
            ...
            Resources: (_a = {},
                ...
                _a[graphql_transformer_common_1.ResourceConstants.RESOURCES.DynamoDBModelTableLogicalID] = this.makeDynamoDBTable(),
                _a[graphql_transformer_common_1.ResourceConstants.RESOURCES.DynamoDBModelTableAccessIAMRoleLogicalID] = this.makeIAMRole(),
                _a[graphql_transformer_common_1.ResourceConstants.RESOURCES.DynamoDBModelTableDataSourceLogicalID] = this.makeDynamoDBDataSource(),
    ...
    ResourceFactory.prototype.makeDynamoDBTable = function () {
        return new dynamoDb_1.default.Table({
            TableName: cloudform_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.DynamoDBModelTableName),
            KeySchema: [{
    ...
    ResourceFactory.prototype.makeIAMRole = function () {
        return new iam_1.default.Role({
            RoleName: cloudform_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.DynamoDBModelTableAccessIAMRoleName),
                        ...
                        Statement: [
                            {
                                ...
                                Resource: [
                                    cloudform_1.Fn.GetAtt(graphql_transformer_common_1.ResourceConstants.RESOURCES.DynamoDBModelTableLogicalID, 'Arn'),
    ...
    ResourceFactory.prototype.makeDynamoDBDataSource = function () {
        var logicalName = graphql_transformer_common_1.ResourceConstants.RESOURCES.DynamoDBModelTableLogicalID;
        return new appSync_1.default.DataSource({
            ApiId: cloudform_1.Fn.GetAtt(graphql_transformer_common_1.ResourceConstants.RESOURCES.GraphQLAPILogicalID, 'ApiId'),
            Name: logicalName,
            Type: 'AMAZON_DYNAMODB',
            ServiceRoleArn: cloudform_1.Fn.GetAtt(graphql_transformer_common_1.ResourceConstants.RESOURCES.DynamoDBModelTableAccessIAMRoleLogicalID, 'Arn'),
            DynamoDBConfig: {
    ...
    ResourceFactory.prototype.makeCreateResolver = function (type, nameOverride) {
        ...
        return new appSync_1.default.Resolver({
            ApiId: cloudform_1.Fn.GetAtt(graphql_transformer_common_1.ResourceConstants.RESOURCES.GraphQLAPILogicalID, 'ApiId'),
            DataSourceName: cloudform_1.Fn.GetAtt(graphql_transformer_common_1.ResourceConstants.RESOURCES.DynamoDBModelTableDataSourceLogicalID, 'Name'),
            FieldName: fieldName,
            TypeName: 'Mutation',
            RequestMappingTemplate: graphql_mapping_template_1.printBlock('Prepare DynamoDB PutItem Request')(graphql_mapping_template_1.compoundExpression([
                ...
                graphql_mapping_template_1.DynamoDBMappingTemplate.putItem({
                    key: graphql_mapping_template_1.obj({
                        '__typename': graphql_mapping_template_1.obj({ S: graphql_mapping_template_1.str(type) }),
                    ...
                    condition: graphql_mapping_template_1.obj({
                        expression: graphql_mapping_template_1.str("attribute_not_exists(#type) AND attribute_not_exists(#id)"),
                        expressionNames: graphql_mapping_template_1.obj({
                            "#type": graphql_mapping_template_1.str('__typename'),
        ...
        return new appSync_1.default.Resolver({
            ...
            RequestMappingTemplate: graphql_mapping_template_1.print(graphql_mapping_template_1.compoundExpression([
                graphql_mapping_template_1.ifElse(graphql_mapping_template_1.ref(graphql_transformer_common_1.ResourceConstants.SNIPPETS.AuthCondition), graphql_mapping_template_1.compoundExpression([
                    ...
                    graphql_mapping_template_1.qref('$condition.put("expression", "$condition.expression AND attribute_exists(#type) AND attribute_exists(#id)")'),
                    graphql_mapping_template_1.qref('$condition.expressionNames.put("#type", "__typename")'),
                    ...
                    expression: graphql_mapping_template_1.str("attribute_exists(#type) AND attribute_exists(#id)"),
                    expressionNames: graphql_mapping_template_1.obj({
                        "#type": graphql_mapping_template_1.str("__typename"),
                        "#id": graphql_mapping_template_1.str("id")
                    })
