...
export abstract class AmplifyException extends Error {
  constructor(
    name: AmplifyExceptionType,
    classification: AmplifyExceptionClassification,
    options: AmplifyExceptionOptions,
    downstreamException?: Error | undefined,
  );
  // (undocumented)
...
// @public (undocumented)
export type HookExtensions = Record<
  string,
  {
    runtime: string;
...
// @public (undocumented)
export function parseHelpCommands(
  input: $TSAny,
