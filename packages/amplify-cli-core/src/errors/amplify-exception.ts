...
export type AmplifyErrorType =
  ...
  | 'CategoryMetaNotFoundError'
  | 'CFNConditionError'
  | 'CFNOutputError'
  | 'CFNParameterError'
  | 'CloudFormationTemplateError'
  | 'CliInputsFileNotFoundError'
  ...
  | 'StackStateError'
  | 'StorageImportError'
  | 'TeamProviderInfoNotFoundError'
  | 'TpiEnvironmentMismatchError'
  | 'TpiEnvironmentNotFoundError'
...
export type AmplifyFaultType =
  ...
  | 'ResourceAddFault'
  | 'RegexMatchingFault'
  | 'ResourceAssessmentNotFoundFault'
  | 'ResourceExportFault'
