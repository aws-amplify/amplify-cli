...
export const CNF_ERROR_STATUS = ['CREATE_FAILED', 'DELETE_FAILED', 'UPDATE_FAILED', 'UPDATE_ROLLBACK_FAILED', 'ROLLBACK_FAILED'];
 ...
 */
export const createProgressBarFormatter = (payload: ProgressPayload, value: number, total: number): string => {
