...
export const invokeAnalyticsResourceToggleNotificationChannel = async (context: $TSContext, resourceProviderServiceName: string,
  ...
  const createResourceResponse = (await context.amplify.invokePluginMethod(context,
    'analytics', undefined,
    'analyticsAPICreateResource', [context, resourceProviderServiceName, channel, enableChannel])) as AnalyticsCapabilityAPIResponse;
