...
function updateaServiceMeta(context) {
    ...
    const currentAmplifyMetaFilePath = context.amplify.pathManager.getCurentBackendCloudAmplifyMetaFilePath();
    let currentAmplifyMeta = JSON.parse(fs.readFileSync(currentAmplifyMetaFilePath));
