...
export class NotificationsMeta {
   ...
   */
  public static toggleNotificationsChannelAppMeta = async (
    channelName: string,
    isEnabled: boolean,
    amplifyMeta?: $TSMeta,
    appName?: string,
  ...
  public static isNotificationChannelEnabled = (
  ...
  public static addPartialNotificationsAppMeta = async (context: $TSContext, notificationResourceName: string):Promise<$TSMeta> => {
    ...
    return NotificationsMeta.constructPartialNotificationsAppMeta(updatedAmplifyMeta,
   ...
   */
  public static constructPartialNotificationsAppMeta = (
    amplifyMeta: $TSMeta,
    resourceName: string,
   ...
   */
  public static constructResourceMeta = (amplifyMeta : $TSMeta,
   ...
   */
  protected static getNotificationsAppListMeta = async (
    amplifyMeta?: $TSMeta,
    appName?: string,
