...
var CloudFormationClient = /** @class */ (function () {
    ...
    CloudFormationClient.prototype.createStack = function (template, name) {
        return __awaiter(this, void 0, void 0, function () {
            var params;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        params = [
                            ...
                            {
                                ParameterKey: amplify_graphql_transformer_common_1.ResourceConstants.PARAMETERS.DynamoDBModelTableAccessIAMRoleName,
