...
describe('Get current aws-exports', () => {
  ...
  const generateAwsExportsFileContents = (object): string => `
/* eslint-disable */
// WARNING: DO NOT EDIT. This file is automatically generated by AWS Amplify. It will be overwritten.

const awsmobile = ${JSON.stringify(object, null, 2)};
...
describe('generate maps and search configuration', () => {
  const constructMapMeta = (mapName, mapStyle, isDefault, region?): $TSAny => ({
  ...
  const constructPlaceIndexMeta = (indexName, isDefault, region?): $TSAny => ({
  ...
  const constructGeofenceCollectionMeta = (collectionName, isDefault, region?): $TSAny => ({
