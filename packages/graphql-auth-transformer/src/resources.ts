...
export class ResourceFactory {
  ...
  public makeAppSyncApiKey(apiKeyConfig: Transformer.ApiKeyConfig) {
    ...
    let expirationDateInSeconds = 60 * 60 * 24 * expirationDays; // sec * min * hour * days
    ...
    // if an iterative deployment takes longer than 30 mins, and API key expiration is set to 1 day, deployments may still fail
