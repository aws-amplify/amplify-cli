...
export class AppSyncService {
  ...
  async Hero(input: HeroQueryVariables): Promise<HeroQuery> {
  ...
  async Reviews(input: ReviewsQueryVariables): Promise<ReviewsQuery> {
  ...
  async Search(input: SearchQueryVariables): Promise<SearchQuery> {
  ...
  async Character(input: CharacterQueryVariables): Promise<CharacterQuery> {
  ...
  async Droid(input: DroidQueryVariables): Promise<DroidQuery> {
  ...
  async Human(input: HumanQueryVariables): Promise<HumanQuery> {
  ...
  async Starship(input: StarshipQueryVariables): Promise<StarshipQuery> {
  ...
  async CreateReview(input: CreateReviewMutationVariables): Promise<CreateReviewMutation> {
  ...
  async ReviewAdded(input: ReviewAddedSubscriptionVariables): Promise<ReviewAddedSubscription> {
