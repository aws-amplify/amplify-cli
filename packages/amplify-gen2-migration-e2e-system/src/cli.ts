...
async function initializeAppFromCLI(params: InitializeAppFromCLIParams): Promise<void> {
  ...
  try {
    ...
    // Step 4.5: Initialize git repo and commit the Gen1 state
    ...
    // Step 5: Run gen2-migration pre-deployment workflow (lock -> checkout -> generate)
    ...
    // Step 7: Commit Gen2 generated code
    ...
    // Step 8: Deploy Gen2 using ampx sandbox
    ...
    // Step 9: Checkout back to main branch for refactor (refactor must run from Gen1 branch)
    ...
    // Step 10: Run refactor to move stateful resources from Gen1 to Gen2
    ...
    // Step 11: Checkout back to Gen2 branch for post-refactor edits
    ...
    // Step 12: Run app-specific post-refactor script
    await runPostRefactorScript(appName, targetAppPath, envName);

    // Step 13: Commit post-refactor changes
    ...
    // Step 14: Redeploy Gen2 to pick up post-refactor changes
