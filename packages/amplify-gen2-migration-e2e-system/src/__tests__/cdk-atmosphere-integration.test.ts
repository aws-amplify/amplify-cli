...
import { AtmosphereAllocation } from '../types';

// Test helper functions
function hasValidCredentials(allocation: AtmosphereAllocation | undefined): boolean {
  return !!allocation && !!allocation.accessKeyId && !!allocation.secretAccessKey;
}

function getCredentialsSummary(allocation: AtmosphereAllocation | undefined): Record<string, unknown> {
  if (!allocation) {
...
describe('CDK Atmosphere Integration', () => {
  ...
  let cachedAllocation: AtmosphereAllocation | undefined;
  ...
  describe('Utility Methods', () => {
    it('should provide credentials status', () => {
      const hasCredentials = hasValidCredentials(cachedAllocation);
    ...
    it('should provide credentials summary', () => {
      const summary = getCredentialsSummary(cachedAllocation);
