...
## [7.4.12-pkg-npm-install.0](https://github.com/aws-amplify/amplify-cli/compare/graphql-transformers-e2e-tests@7.4.11...graphql-transformers-e2e-tests@7.4.12-pkg-npm-install.0) (2022-03-31)
