...
var CloudFormationClient = /** @class */ (function () {
    ...
    CloudFormationClient.prototype.createStack = function (template, name, defParams) {
        if (defParams === void 0) { defParams = {}; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        for (_i = 0, _a = Object.keys(defParams); _i < _a.length; _i++) {
                            key = _a[_i];
                            params.push({
                                ParameterKey: key,
