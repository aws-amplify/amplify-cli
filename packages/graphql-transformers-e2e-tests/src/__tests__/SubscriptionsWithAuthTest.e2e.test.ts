...
beforeAll(async () => {
    ...
    try {
        ...
        GRAPHQL_IAM_AUTH_CLIENT = new AWSAppSyncClient({ url: GRAPHQL_ENDPOINT, region: AWS_REGION,
            disableOffline: true,
            offlineConfig: {
                keyPrefix: 'iam'
            },
        ...
        GRAPHQL_APIKEY_CLIENT = new AWSAppSyncClient({ url: GRAPHQL_ENDPOINT, region: AWS_REGION,
            disableOffline: true,
            offlineConfig: {
                keyPrefix: 'apikey'
            },
...
test('Test subscription onCreatePost with ownerField', async done => {
    const observer = GRAPHQL_CLIENT_1.subscribe({ query: gql`
...
test('test that subcsription with apiKey', async done => {
    const observer = GRAPHQL_APIKEY_CLIENT.subscribe({ query: gql`
...
async function updateStudent(client: AWSAppSyncClient<any>, input: UpdateStudentInput) {
    const request = gql`mutation UpdateStudent($input: UpdateStudentInput!) {
...
async function deleteStudent(client: AWSAppSyncClient<any>, input: DeleteTypeInput) {
    const request = gql`mutation DeleteStudent($input: DeleteStudentInput!) {
...
async function createPost(client: AWSAppSyncClient<any>, input: CreatePostInput) {
    const request = gql`mutation CreatePost($input: CreatePostInput!) {
...
async function createTodo(client: AWSAppSyncClient<any>, input: CreateTodoInput) {
    const request = gql`mutation CreateTodo($input: CreateTodoInput!) {
...
async function updateTodo(client: AWSAppSyncClient<any>, input: UpdateTodoInput) {
    const request = gql`mutation UpdateTodo($input: UpdateTodoInput!) {
...
async function deleteTodo(client: AWSAppSyncClient<any>, input: DeleteTypeInput) {
    const request = gql`mutation DeleteTodo($input: DeleteTodoInput!) {
