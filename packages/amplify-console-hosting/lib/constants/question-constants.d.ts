export const DEPLOY_TYPE_QUESTION: string;
...
export const VIEW_APP_QUESTION: string;
...
export const POST_ADDING_MESSAGE: string;
export const POST_PUBLISH_MESSAGE: "Command: amplify publish";
//# sourceMappingURL=question-constants.d.ts.map