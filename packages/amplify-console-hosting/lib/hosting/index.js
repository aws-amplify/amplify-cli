...
const HOSTING_ENABLED_IN_CONSOLE = 'You have enabled hosting in the Amplify Console and not through the CLI. To remove hosting with Amplify Console, please visit the console and disconnect your frontend branches.';
const HOSTING_ALREADY_ENABLED = 'Amplify Console hosting has already been enabled';
const FRONTEND_EXISTED_WARNING = 'You have already connected branches to your Amplify Console app. Please visit the Amplify Console to manage your branches.';
