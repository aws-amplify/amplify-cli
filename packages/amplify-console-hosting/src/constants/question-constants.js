...
export const CICD_CONFIRM_QUESTION =
...
export const APP_CONFIGURE_QUESTION =
  'Configure settings such as custom domains, redirects, and password protection using the Amplify Console. Continue?';
export const APP_CICD_SERVE_QUESTION =
  'You have set up continuous deployment with Amplify Console. Open your Amplify Console app to view connected branches?';
