...
export const exportHostedUIProvidersFromCurrCloudRootStack = async (resourceName: string, providerMeta: $TSObject[], updatedUIProviderCreds: $TSObject[]): Promise<$TSObject[]> => {
