 ...
 */
export const getAddAuthDefaultsApplier = (context: $TSContext, defaultValuesFilename: string, projectName: string) => async (
  result: CognitoConfiguration | ServiceQuestionHeadlessResult,
...
export const getUpdateAuthDefaultsApplier = (
  ...
  previousResult: CognitoConfiguration,
