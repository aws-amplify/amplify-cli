...
import { GetUserPoolMfaConfigResponse, IdentityProviderType, UserPoolClientType, UserPoolType } from 'aws-sdk/clients/cognitoidentityserviceprovider';
...
export interface ProviderUtils {
    ...
    saveResourceParameters(context: $TSContext, category: string, resourceName: string, privateParams: $TSObject, envSpecificParams: string[]): void;
