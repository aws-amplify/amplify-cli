...
exports.getSupportedServices = void 0;
    ...
    Cognito: {
        inputs: [
            ...
            },
            {
                ...
                learnMore: 'If you select yes, your identity pool will support users who are authenticated via a public login provider such as Facebook, Google, and Amazon (non-Cognito).  Your identity pool will continue to support users who are authenticated via a user pool.',
                temp: true,
                type: 'list',
                map: 'booleanOptions',
                required: true,
            ...
            },
            {
                ...
                learnMore: "Selecting 'Email' and/or 'Phone Number' will allow end users to sign-up using these values.  Selecting 'Username' will require a unique username for users.",
                andConditions: [
                    {
                        key: 'authSelections',
                        value: 'identityPoolOnly',
            ...
            },
            {
                ...
                learnMore: 'When you create a user pool in Amazon Cognito and configure a domain for it, Amazon Cognito automatically provisions a hosted web UI to let you add sign-up and sign-in pages to your app. Selecting "No" will remove any existing OAuth configuration.',
                required: true,
                type: 'list',
                map: 'booleanOptions',
                andConditions: [
            ...
            },
            {
                ...
                validation: {
                    ...
                    onErrorMsg: "The value must be a valid domain name format.  A valid format consists of lowercase alphanumeric characters or hyphens. Hyphens cannot be at the beginning or end of the string. The domain cannot use the reserved words 'aws', 'amazon', or 'cognito'.",
                },
            },
            {
                key: 'newCallbackURLs',
            ...
            },
            {
                ...
                validation: {
                    ...
                    onErrorMsg: 'Private key provided is invalid. You must provide the entire key (including the -----BEGIN PRIVATE KEY----- and -----END PRIVATE KEY----- on a single line)',
                },
            },
        ],
...
const getSupportedServices = () => {
    const keyToRemove = amplify_cli_core_1.FeatureFlags.getBoolean('auth.forceAliasAttributes') ? 'usernameAttributes' : 'aliasAttributes';
