...
import { getCreatedAtFieldName, getUpdatedAtFieldName } from './model-directive-args';
...
export function makeCreateInputObject(
  ...
  const autoGeneratableFieldsWithType: Record<string, string[]> = {
    id: ['ID'],
    ...(createdAtField ? { [createdAtField]: ['AWSDateTime', 'String'] } : {}),
    ...(updatedAtField ? { [updatedAtField]: ['AWSDateTime', 'String'] } : {}),
  };
