 ...
 * In cdkV2 this function is not exported by the library. This function is copied from above to get previous behavior
 */
 ...
 */
export const prepareApp = (root: IConstruct): void => {
