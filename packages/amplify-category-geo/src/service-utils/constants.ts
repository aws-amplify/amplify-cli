...
export const choosePricingPlan = `The following choices determine and update the pricing plan for ALL Geo resources in the project. Learn more at ${apiDocs.pricingPlan}`;
