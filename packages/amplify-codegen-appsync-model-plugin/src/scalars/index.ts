...
export const JAVA_SCALAR_MAP: NormalizedScalarsMap = {
  ...
  Float: 'Float',
  Boolean: 'Boolean',
  AWSDate: 'com.amplifyframework.core.model.AWSDate',
  AWSDateTime: 'com.amplifyframework.core.model.AWSDateTime',
  AWSTime: 'com.amplifyframework.core.model.AWSTime',
  AWSTimestamp: 'com.amplifyframework.core.model.AWSTimestamp',
  AWSEmail: 'String',
  AWSJSON: 'String',
  AWSURL: 'String',
  AWSPhone: 'String',
