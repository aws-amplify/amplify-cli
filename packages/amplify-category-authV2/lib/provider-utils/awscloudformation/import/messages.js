...
exports.importMessages = {
  ...
  SingleAppClientSelected: (type, appClientName) =>
  ...
  OneIdentityPoolValid: (identityPoolName, identityPoolId) =>
  ...
  NewEnvDifferentRegion: (resourceName, currentEnvRegion, newEnvRegion) =>
  ...
  NoClientInUserPool: (userPoolId, type, clientId) =>
  ...
  ImportNewResourceRequired: resourceName =>
  ...
  Questions: {
    ...
    ImportPreviousResource: (resourceName, userPoolId, envName) =>
