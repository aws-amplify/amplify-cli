...
export function generalDefaults(
  projectName: any,
): {
  authRoleArn: {
    'Fn::GetAtt': string[];
...
export function withSocialDefaults(
  projectName: any,
): {
  hostedUI: boolean;
...
declare function userPoolDefaults(
  projectName: any,
): {
  resourceNameTruncated: string;
  userPoolName: string;
...
declare function identityAndUserPoolDefaults(
  projectName: any,
): {
  resourceNameTruncated: string;
  userPoolName: string;
...
declare function identityPoolDefaults(
  projectName: any,
): {
  identityPoolName: string;
  allowUnauthenticatedIdentities: boolean;
