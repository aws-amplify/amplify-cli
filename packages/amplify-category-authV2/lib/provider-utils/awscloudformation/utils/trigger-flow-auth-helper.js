...
exports.handleTriggers = handleTriggers;
const saveTriggerEnvParamsToTeamProviderInfo = async (context, key, value, functionName, currentEnvVars) => {
  ...
  if (!amplify_cli_core_1.FeatureFlags.getBoolean('auth.useInclusiveTerminology') && key === 'PreSignup') {
