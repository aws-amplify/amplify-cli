...
const unit_resolver_1 = require("../../resolvers/unit-resolver");
...
describe('Unit resolver', () => {
    ...
    it('should initialize when the request and response mapping templates are inline templates', () => {
        ...
        expect(() => new unit_resolver_1.AppSyncUnitResolver(config, simulatorContext)).not.toThrow();
    ...
    it('should throw error when templates are missing', () => {
        ...
        expect(() => new unit_resolver_1.AppSyncUnitResolver(baseConfig, simulatorContext)).toThrowError('Missing response mapping template mock error');
    ...
    describe('resolve', () => {
        ...
        beforeEach(() => {
            ...
            resolver = new unit_resolver_1.AppSyncUnitResolver({ ...baseConfig, requestMappingTemplateLocation: 'request', responseMappingTemplateLocation: 'response' }, simulatorContext);
        });
...
//# sourceMappingURL=unit-resolver.test.js.map