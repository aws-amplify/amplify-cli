...
describe('getAuthorizationMode', () => {
    ...
    describe('API Key', () => {
        it('should return API_KEY auth mode when configured', () => {
            expect((0, current_auth_mode_1.getAuthorizationMode)({}, APPSYNC_CONFIG)).toEqual(type_definition_1.AmplifyAppSyncSimulatorAuthenticationType.API_KEY);
        });
        it('should throw error when API key does not match', () => {
            APPSYNC_CONFIG.apiKey = 'not-default';
            expect(() => (0, current_auth_mode_1.getAuthorizationMode)({}, APPSYNC_CONFIG)).toThrow('UnauthorizedException: Invalid API key');
        });
        it('should throw error when API_KEY is not one of the allowed Auth', () => {
            ...
            expect(() => (0, current_auth_mode_1.getAuthorizationMode)({}, APPSYNC_CONFIG)).toThrow('UnauthorizedException: Invalid JWT token');
        });
    });
    describe('IAM', () => {
        beforeEach(() => {
        ...
        it('should return IAM when Authorization starts with AWS4-HMAC-SHA256', () => {
            ...
            expect((0, current_auth_mode_1.getAuthorizationMode)({}, APPSYNC_CONFIG)).toEqual(type_definition_1.AmplifyAppSyncSimulatorAuthenticationType.AWS_IAM);
        });
    ...
    describe('Cognito User Pools', () => {
        ...
        it('should return AMAZON_COGNITO_USER_POOLS as authorization mode', () => {
            ...
            expect((0, current_auth_mode_1.getAuthorizationMode)({}, APPSYNC_CONFIG)).toEqual(type_definition_1.AmplifyAppSyncSimulatorAuthenticationType.AMAZON_COGNITO_USER_POOLS);
        });
    ...
    describe('OpenID Connect', () => {
        ...
        it('should return OIDC as authorization mode', () => {
            ...
            expect((0, current_auth_mode_1.getAuthorizationMode)({}, APPSYNC_CONFIG)).toEqual(type_definition_1.AmplifyAppSyncSimulatorAuthenticationType.OPENID_CONNECT);
    ...
    it('should throw error when not auth type matches', () => {
        ...
        expect(() => (0, current_auth_mode_1.getAuthorizationMode)({}, APPSYNC_CONFIG)).toThrow('UnauthorizedException: Missing authorization');
    });
});
