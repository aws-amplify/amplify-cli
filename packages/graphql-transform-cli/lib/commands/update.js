...
function updateStack(template, name, region) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const params = [
            ...
            {
                ParameterKey: graphql_transformer_common_1.ResourceConstants.PARAMETERS.ElasticSearchDomainName,
                UsePreviousValue: true
            },
            {
                ParameterKey: graphql_transformer_common_1.ResourceConstants.PARAMETERS.ElasticSearchAccessIAMRoleName,
                UsePreviousValue: true
            },
            {
                ParameterKey: graphql_transformer_common_1.ResourceConstants.PARAMETERS.ElasticSearchStreamingIAMRoleName,
                UsePreviousValue: true
            }
        ];
