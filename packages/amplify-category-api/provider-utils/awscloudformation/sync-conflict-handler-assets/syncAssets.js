...
Optimistic Concurrency Control accepts the latest committed write to the database and other writers are rejected and must handle merges through other means, such as a client-side callback.
...
export function getLearnMore() {
  return chalkpipe(null, chalk.green)(learnMore);
}
