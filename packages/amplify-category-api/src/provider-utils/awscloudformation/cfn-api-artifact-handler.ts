...
class CfnApiArtifactHandler implements ApiArtifactHandler {
  ...
  createArtifacts = async (request: AddApiRequest): Promise<string> => {
    ...
    if (!fs.existsSync(resolverDirectoryPath)) {
      ...
      const resolversReadMe = `Any resolvers that you add in this directory will override the ones automatically generated by Amplify CLI and will be directly copied to the cloud. 
For more information, visit [https://docs.amplify.aws/cli/graphql-transformer/resolvers](https://docs.amplify.aws/cli/graphql-transformer/resolvers)`;
      fs.writeFileSync(`${resolverDirectoryPath}/README.md`, resolversReadMe, 'utf-8');
    }
