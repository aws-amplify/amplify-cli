...
import { authConfigHasApiKey, checkIfAuthExists, getAppSyncAuthConfig, getAppSyncLogConfig } from '../utils/amplify-meta-utils';
...
const updateApiInputWalkthrough = async (context: $TSContext, project: $TSObject, resolverConfig, modelTypes, logConfig) => {
  let authConfig;
  let defaultAuthType;
  const updateChoices = [
    {
