...
describe('nodejs version migration tests', () => {
  ...
  it('init a project and add simple function and migrate node version', async () => {
    ...
    authStackContent = authStackContent.replace('nodejs18.x', 'nodejs10.x');
    ...
    functionStackContent = functionStackContent.replace('nodejs18.x', 'nodejs10.x');
    ...
    expect(authStackContent.indexOf('nodejs18.x')).toBeGreaterThan(0);
    expect(functionStackContent.indexOf('nodejs18.x')).toBeGreaterThan(0);
  });
