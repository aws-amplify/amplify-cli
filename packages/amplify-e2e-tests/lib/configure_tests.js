...
var AWS_CREDENTIAL_PATH = path_1.join(os_1.homedir(), '.aws', 'credentials');
function setUpAmplify() {
    return __awaiter(this, void 0, void 0, function () {
        var AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!utils_1.isCI()) return [3 /*break*/, 2];
                    ...
                    return [4 /*yield*/, configure_1.default({
