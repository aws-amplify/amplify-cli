    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    awsconfig = (0, amplify_e2e_core_1.getAwsAndroidConfig)(projectDir);
                    userPoolId = (0, authHelper_1.getUserPoolId)(projectDir);
                    return [4 /*yield*/, configureAmplifyForAndroid(awsconfig)];
                case 4:
                    _a.sent();
...
function configureAmplifyForAndroid(awsconfig) {
    return __awaiter(this, void 0, void 0, function () {
        var CredentialsProvider, CognitoUserPool, AppSync;
        return __generator(this, function (_a) {
            CredentialsProvider = awsconfig.CredentialsProvider, CognitoUserPool = awsconfig.CognitoUserPool, AppSync = awsconfig.AppSync;
...
/* eslint-enable */
//# sourceMappingURL=auth-owner9.js.map