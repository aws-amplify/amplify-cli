...
function runTest(projectDir, testModule) {
    return __awaiter(this, void 0, void 0, function () {
        var amplifyConfig, userPoolId, user, appSyncClient;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    amplifyConfig = (0, amplify_e2e_core_1.getAmplifyFlutterConfig)(projectDir);
                    userPoolId = (0, authHelper_1.getUserPoolId)(projectDir);
                    return [4 /*yield*/, configureAmplifyForFlutter(amplifyConfig)];
                case 4:
                    _a.sent();
                ...
                case 6:
                    user = _a.sent();
                    appSyncClient = (0, authHelper_1.getConfiguredAppsyncClientCognitoAuth)(amplifyConfig.aws_appsync_graphqlEndpoint, amplifyConfig.aws_appsync_region, user);
...
function configureAmplifyForFlutter(amplifyConfig) {
    return __awaiter(this, void 0, void 0, function () {
        var config, CredentialsProvider, CognitoUserPool, AppSync;
        return __generator(this, function (_a) {
            config = amplifyConfig.auth.plugins.awsCognitoAuthPlugin;
            CredentialsProvider = config.CredentialsProvider, CognitoUserPool = config.CognitoUserPool, AppSync = config.AppSync;
            ...
            aws_amplify_1.default.configure(amplifyConfig);
            return [2 /*return*/];
        });
    });
}
...
/* eslint-enable */
//# sourceMappingURL=auth-owner11.js.map