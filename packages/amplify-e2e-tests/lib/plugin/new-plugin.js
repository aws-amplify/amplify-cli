...
exports.newPlugin = void 0;
var amplify_e2e_core_1 = require("@aws-amplify/amplify-e2e-core");
function newPlugin(cwd) {
    return __awaiter(this, void 0, void 0, function () {
        var pluginPackageDirName;
        return __generator(this, function (_a) {
            pluginPackageDirName = 'newpluginpackage';
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    (0, amplify_e2e_core_1.nspawn)((0, amplify_e2e_core_1.getCLIPath)(), ['plugin', 'init'], { cwd: cwd, stripColors: true })
