...
describe('notification category compatibility test', function () {
    ...
    it("works with existing pinpoint that has pushed", function () { return __awaiter(void 0, void 0, void 0, function () {
        var pinpointResourceName, appId, settings;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, amplify_e2e_core_1.addNotificationChannel)(projectRoot, settings, 'In-App Messaging', true, true)];
                case 4:
                    _a.sent();
                    // PUSH NOTIFICATIONS
...
//# sourceMappingURL=notifications-analytics-compatibility-in-app-2.test.js.map