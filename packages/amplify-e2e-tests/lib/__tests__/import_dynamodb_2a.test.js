...
describe('dynamodb import 2a', function () {
    ...
    it('imported dynamodb table, create prod env, files should match', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    (0, import_helpers_1.expectDynamoDBLocalAndOGMetaFilesOutputMatching)(projectRoot, ogProjectRoot);
...
//# sourceMappingURL=import_dynamodb_2a.test.js.map