...
describe('amplify add hosting', function () {
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var hostingBucket, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    hostingBucket = (0, amplify_e2e_core_1.extractHostingBucketInfo)(projRoot);
                ...
                case 3:
                    _b.sent();
                    if (!hostingBucket) return [3 /*break*/, 7];
                    _b.label = 4;
                case 4:
                    _b.trys.push([4, 6, , 7]);
    ...
    it('publish successfully with yes flag', function () { return __awaiter(void 0, void 0, void 0, function () {
        var error, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, amplify_e2e_core_1.amplifyPublishWithoutUpdateWithYesFlag)(projRoot)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('publish throws error if build command is missing', function () { return __awaiter(void 0, void 0, void 0, function () {
        var currentBuildCommand, error, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
