...
describe('amplify add api (GraphQL) - Lambda Authorizer', function () {
    ...
    it('init a project and add the api with lambda auth multiple env', function () { return __awaiter(void 0, void 0, void 0, function () {
        var envName, projName, meta, region, output, GraphQLAPIIdOutput, GraphQLAPIEndpointOutput, GraphQLAPIKeyOutput, graphqlApi;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    envName = 'devtest';
                    projName = 'lambdaauthenv';
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.updateApiSchema)(projRoot, projName, 'lambda-auth-field-auth-v2.graphql')];
                case 3:
                    _a.sent();
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, env_1.addEnvironment)(projRoot, { envName: 'testenv' })];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, (0, env_1.listEnvironment)(projRoot, { numEnv: 2 })];
                case 7:
                    _a.sent();
                    return [4 /*yield*/, (0, env_1.checkoutEnvironment)(projRoot, { envName: 'testenv' })];
                case 8:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.amplifyPush)(projRoot)];
                case 9:
    ...
    it('init a project and add the simple_model api include lambda auth', function () { return __awaiter(void 0, void 0, void 0, function () {
        var envName, projName, meta, region, output, GraphQLAPIIdOutput, GraphQLAPIEndpointOutput, GraphQLAPIKeyOutput, graphqlApi, url, apiKey, appSyncClient, createMutation, createInput, createResult, updateMutation, createResultData, updateInput, updateResult, updateResultData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    envName = 'devtest';
...
//# sourceMappingURL=api_lambda_auth_1.test.js.map