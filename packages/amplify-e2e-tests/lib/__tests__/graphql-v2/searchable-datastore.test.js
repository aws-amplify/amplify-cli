...
describe('transformer model searchable migration test', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, amplify_e2e_core_1.addApiWithoutSchema)(projRoot, { apiName: projectName })];
                case 1:
                    _a.sent();
    ...
    var runQuery = function (query) { return __awaiter(void 0, void 0, void 0, function () {
        var q, response, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, appSyncClient.query({
                            query: (0, graphql_tag_1.default)(q),
                            fetchPolicy: 'no-cache',
                        })];
                case 1:
                    response = _a.sent();
    ...
    var searchTodos = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, runQuery(getTodos())];
            case 1: return [2 /*return*/, _a.sent()];
        }
    }); }); };
    ...
    var runAndValidateQuery = function (name, description, count) { return __awaiter(void 0, void 0, void 0, function () {
        var response, searchResponse, expectedRows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, waitForOSPropagate()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, searchTodos()];
                case 3:
    ...
    var waitForOSPropagate = function (initialWaitSeconds, maxRetryCount) {
        if (initialWaitSeconds === void 0) { initialWaitSeconds = 5; }
        if (maxRetryCount === void 0) { maxRetryCount = 5; }
        return __awaiter(void 0, void 0, void 0, function () {
            var expectedCount, waitInMilliseconds, currentRetryCount, searchResponse;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        expectedCount = 1;
                        waitInMilliseconds = initialWaitSeconds * 1000;
                        currentRetryCount = 0;
                        _c.label = 1;
                    case 1: return [4 /*yield*/, new Promise(function (r) { return setTimeout(r, waitInMilliseconds); })];
                    case 2:
                        _c.sent();
                        return [4 /*yield*/, searchTodos()];
                    case 3:
                        ...
                        _c.label = 4;
                    case 4:
                        if (((_b = (_a = searchResponse.data.searchTodos) === null || _a === void 0 ? void 0 : _a.items) === null || _b === void 0 ? void 0 : _b.length) < expectedCount && currentRetryCount <= maxRetryCount) return [3 /*break*/, 1];
                        _c.label = 5;
...
//# sourceMappingURL=searchable-datastore.test.js.map