...
describe('environment commands with recaptcha trigger', function () {
    var projRoot;
    ...
    it('init a project, add and checkout environment', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, env_1.addEnvironment)(projRoot, { envName: 'envb' })];
                case 1:
                    _a.sent();
...
//# sourceMappingURL=env-4.test.js.map