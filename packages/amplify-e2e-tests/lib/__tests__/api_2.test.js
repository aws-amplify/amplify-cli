...
describe('amplify add api (GraphQL)', function () {
    ...
    it('init a project with conflict detection enabled and admin UI enabled to generate DataStore models in the cloud', function () { return __awaiter(void 0, void 0, void 0, function () {
        var name, meta, appId, region, localEnvInfo, envName, output, GraphQLAPIIdOutput, GraphQLAPIEndpointOutput, GraphQLAPIKeyOutput, graphqlApi;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    name = 'dsadminui';
                    return [4 /*yield*/, (0, amplify_e2e_core_1.initJSProjectWithProfile)(projRoot, { disableAmplifyAppCreation: false, name: name })];
                case 1:
                    _e.sent();
                    meta = (0, amplify_e2e_core_1.getProjectMeta)(projRoot);
                    appId = (_b = (_a = meta.providers) === null || _a === void 0 ? void 0 : _a[providerName]) === null || _b === void 0 ? void 0 : _b.AmplifyAppId;
                    region = (_d = (_c = meta.providers) === null || _c === void 0 ? void 0 : _c[providerName]) === null || _d === void 0 ? void 0 : _d.Region;
    ...
    it('init a sync enabled project and update conflict resolution strategy', function () { return __awaiter(void 0, void 0, void 0, function () {
        var name, transformConfig, meta, output, GraphQLAPIIdOutput, GraphQLAPIEndpointOutput, GraphQLAPIKeyOutput, graphqlApi;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    name = 'syncenabled';
                ...
                case 3:
                    ...
                    expect(transformConfig.ResolverConfig.project.ConflictDetection).toEqual('VERSION');
                    expect(transformConfig.ResolverConfig.project.ConflictHandler).toEqual('AUTOMERGE');
                    return [4 /*yield*/, (0, amplify_e2e_core_1.updateAPIWithResolutionStrategyWithModels)(projRoot, {})];
                case 4:
                    _a.sent();
                    transformConfig = (0, amplify_e2e_core_1.getTransformConfig)(projRoot, name);
                    expect(transformConfig).toBeDefined();
...
//# sourceMappingURL=api_2.test.js.map