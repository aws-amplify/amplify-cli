...
describe('amplify geo remove', function () {
    ...
    it('init a project with default auth config and multiple map resources, then remove the default map', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, map1Id, map2Id, map3Id, oldMeta, map1Name, map2Name, region, newMeta, awsExport;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    ...
                    map1Name = oldMeta.geo[map1Id].output.Name;
                    map2Name = oldMeta.geo[map2Id].output.Name;
                    region = oldMeta.geo[map1Id].output.Region;
                    // remove map
                    return [4 /*yield*/, (0, amplify_e2e_core_1.removeFirstDefaultMap)(projRoot)];
                case 7:
                    // remove map
                    _b.sent();
                ...
                case 8:
                    ...
                    expect((0, amplify_e2e_core_1.getGeoJSConfiguration)(awsExport).maps.items[map1Name]).toBeUndefined();
    ...
    it('init a project with default auth config and multiple index resources, then remove the default index', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, index1Id, index2Id, index3Id, oldMeta, index1Name, index2Name, region, newMeta, awsExport;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 6:
                    ...
                    index1Name = oldMeta.geo[index1Id].output.Name;
                    index2Name = oldMeta.geo[index2Id].output.Name;
                    region = oldMeta.geo[index1Id].output.Region;
                    // remove place index
                    return [4 /*yield*/, (0, amplify_e2e_core_1.removeFirstDefaultPlaceIndex)(projRoot)];
                case 7:
                    // remove place index
                    _b.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.amplifyPushUpdate)(projRoot)];
                case 8:
                    ...
                    expect((0, amplify_e2e_core_1.getGeoJSConfiguration)(awsExport).search_indices.items).not.toContain(index1Name);
...
//# sourceMappingURL=geo-remove-2.test.js.map