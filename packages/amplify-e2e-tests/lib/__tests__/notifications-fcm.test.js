...
describe('notification category test - FCM', function () {
    var testChannel = 'FCM';
    var testChannelSelection = 'FCM  | » Firebase Push Notifications ';
    ...
    it.skip("should add and remove the ".concat(testChannel, " channel correctly when no pinpoint is configured"), function () { return __awaiter(void 0, void 0, void 0, function () {
        var settings, appId;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
//# sourceMappingURL=notifications-fcm.test.js.map