...
describe('amplify geo add a', function () {
    var projRoot;
    ...
    it('init a project with default auth config and add the map resource', function () { return __awaiter(void 0, void 0, void 0, function () {
        var meta, mapId, mapName, region, map, awsExport;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    mapId = lodash_1.default.findKey(meta.geo, ['service', 'Map']);
                    mapName = meta.geo[mapId].output.Name;
                    region = meta.geo[mapId].output.Region;
...
//# sourceMappingURL=geo-add-a.test.js.map