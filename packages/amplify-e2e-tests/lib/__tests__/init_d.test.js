...
describe('amplify init d', function () {
    var projRoot;
    ...
    it('init the project simulate checked in local-env-info with wrong path', function () { return __awaiter(void 0, void 0, void 0, function () {
        var localEnvPath, localEnvData, originalPath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, amplify_e2e_core_1.initJSProjectWithProfile)(projRoot, {})];
                case 1:
                    _a.sent();
                    localEnvPath = path.join(projRoot, 'amplify', '.config', 'local-env-info.json');
                    expect(fs.existsSync(localEnvPath)).toBe(true);
                    localEnvData = fs.readJsonSync(localEnvPath);
                    originalPath = localEnvData.projectPath;
                    ...
                    return [4 /*yield*/, (0, amplify_e2e_core_1.amplifyStatus)(projRoot, 'Current Environment')];
                case 2:
                    // execute amplify status, which involves feature flags initialization, it must succeed
                    _a.sent();
...
//# sourceMappingURL=init_d.test.js.map