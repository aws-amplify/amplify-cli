...
describe('amplify add auth...', function () {
    ...
    it('...should init a project and add auth with defaults, pull project and push again', function () { return __awaiter(void 0, void 0, void 0, function () {
        var appId, projRootPullAuth;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, amplify_e2e_core_1.createNewProjectDir)('authPullTest')];
                case 4:
                    projRootPullAuth = _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.amplifyPull)(projRootPullAuth, {
                            emptyDir: true,
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.updateAuthSignInSignOutUrl)(projRootPullAuth, {
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.amplifyPushAuth)(projRootPullAuth)];
                case 7:
                    _a.sent();
                    (0, amplify_e2e_core_1.deleteProjectDir)(projRootPullAuth);
                    return [2 /*return*/];
            }
        });
    }); });
});
//# sourceMappingURL=auth_1b.test.js.map