...
describe('amplify geo add', function () {
    var projRoot;
    ...
    it('init a project with default auth config and add two geofence collection resources with the second set to default', function () { return __awaiter(void 0, void 0, void 0, function () {
        var collection1Id, collection2Id, cognitoGroups, meta, region, collection1Name, collection2Name, collection1, collection2, awsExport;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    collection1Id = "geofencecollection".concat((0, amplify_e2e_core_1.generateRandomShortId)());
                    collection2Id = "geofencecollection".concat((0, amplify_e2e_core_1.generateRandomShortId)());
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.addGeofenceCollectionWithDefault)(projRoot, cognitoGroups, { resourceName: collection2Id, isAdditional: true })];
                case 5:
                    _a.sent();
...
//# sourceMappingURL=geo-add-f.test.js.map