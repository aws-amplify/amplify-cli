...
describe('headless auth d', function () {
    var projRoot;
    ...
    it('adds auth resource with TOTP only but enables SMS through password recovery', function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    addAuthRequest = {
                        ...
                        serviceConfiguration: {
                            ...
                            userPoolConfiguration: {
                                requiredSignupAttributes: [amplify_headless_interface_1.CognitoUserProperty.EMAIL],
                                passwordRecovery: {
                                    deliveryMethod: 'SMS',
...
//# sourceMappingURL=auth_5d.test.js.map