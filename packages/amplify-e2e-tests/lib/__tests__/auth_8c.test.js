...
describe('amplify add auth...', function () {
    ...
    it('...should init a project and add auth with defaults and then remove auth and add another auth and push', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, amplify_e2e_core_1.initFlutterProjectWithProfile)(projRoot, defaultsSettings)];
                case 1:
                    _a.sent();
...
//# sourceMappingURL=auth_8c.test.js.map