...
describe('amplify api add', function () {
    ...
    it('init project, enable containers and add multi-container api push, edit and push', function () { return __awaiter(void 0, void 0, void 0, function () {
        var envName, apiName, meta, api;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    envName = 'devtest';
                    apiName = "containermodifyapi".concat((0, amplify_e2e_core_1.generateRandomShortId)());
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.getProjectMeta)(projRoot)];
                case 5:
                    meta = _a.sent();
                    api = Object.keys(meta.api)[0];
                    (0, amplify_e2e_core_1.modifyRestAPI)(projRoot, api);
                    return [4 /*yield*/, (0, amplify_e2e_core_1.amplifyPushWithoutCodegen)(projRoot)];
                case 6:
                    _a.sent();
                    return [2 /*return*/];
...
//# sourceMappingURL=containers-api-2.test.js.map