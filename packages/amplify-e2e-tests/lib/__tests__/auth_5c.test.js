...
describe('headless auth c', function () {
    var projRoot;
    ...
    it('adds auth resource with TOTP only but enable SMS through signUp Attributes', function () { return __awaiter(void 0, void 0, void 0, function () {
        var addAuthRequest, meta, id, region, userPool, mfaConfig;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    addAuthRequest = {
                        ...
                        serviceConfiguration: {
                            ...
                            userPoolConfiguration: {
                                requiredSignupAttributes: [amplify_headless_interface_1.CognitoUserProperty.EMAIL, amplify_headless_interface_1.CognitoUserProperty.PHONE_NUMBER],
                                // eslint-disable-next-line spellcheck/spell-checker
                                signinMethod: amplify_headless_interface_1.CognitoUserPoolSigninMethod.PHONE_NUMBER,
                                mfa: {
                                    mode: 'OPTIONAL',
                                    mfaTypes: ['TOTP'],
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.addHeadlessAuth)(projRoot, addAuthRequest)];
                case 2:
                    _a.sent();
                ...
                case 4:
                    userPool = _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.getMFAConfiguration)(id, region)];
                case 5:
                    mfaConfig = _a.sent();
...
//# sourceMappingURL=auth_5c.test.js.map