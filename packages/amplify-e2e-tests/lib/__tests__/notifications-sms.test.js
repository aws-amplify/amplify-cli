...
describe('notification category test - SMS', function () {
    var testChannel = 'SMS';
    ...
    it("should add and remove the ".concat(testChannel, " channel correctly when no pinpoint is configured"), function () { return __awaiter(void 0, void 0, void 0, function () {
        var settings, appId, meta, updatedMeta;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 5:
                    ...
                    expect((_b = (_a = meta.notifications[settings.resourceName]) === null || _a === void 0 ? void 0 : _a.output) === null || _b === void 0 ? void 0 : _b.SMS).toBeDefined();
                    // remove sms only
...
//# sourceMappingURL=notifications-sms.test.js.map