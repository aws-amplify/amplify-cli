...
describe('notification category compatibility test', function () {
    ...
    it("works with existing pinpoint that hasn't pushed", function () { return __awaiter(void 0, void 0, void 0, function () {
        var pinpointResourceName, appId, meta, inAppMessagingMeta, analyticsMeta, teamInfo, pinpointId, updatedMeta, updatedInAppMsgMeta, cloudBackendMeta, cloudBackendInAppMsgMeta, updatedCloudBackendMeta, updatedCloudBackendInAppMsgMeta, finalLocalMeta, endCloudBackendMeta;
        ...
        return __generator(this, function (_o) {
            switch (_o.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, amplify_e2e_core_1.addNotificationChannel)(projectRoot, { resourceName: pinpointResourceName }, testChannelSelection, true, true)];
                case 3:
                    // SETUP NOTIFICATIONS CHANNEL BUT DON'T PUSH (IN-APP MESSAGING)
                    _o.sent();
                    // PUSH BOTH
                ...
                case 7:
                    ...
                    updatedInAppMsgMeta = (_h = (_g = updatedMeta.notifications[pinpointResourceName]) === null || _g === void 0 ? void 0 : _g.output) === null || _h === void 0 ? void 0 : _h.InAppMessaging;
                ...
                case 9:
                    ...
                    cloudBackendInAppMsgMeta = (_k = (_j = cloudBackendMeta.notifications[pinpointResourceName]) === null || _j === void 0 ? void 0 : _j.output) === null || _k === void 0 ? void 0 : _k.InAppMessaging;
                ...
                case 11:
                    ...
                    updatedCloudBackendInAppMsgMeta = (_m = (_l = updatedCloudBackendMeta.notifications[pinpointResourceName]) === null || _l === void 0 ? void 0 : _l.output) === null || _m === void 0 ? void 0 : _m.InAppMessaging;
...
//# sourceMappingURL=notifications-analytics-compatibility-in-app-1.test.js.map