...
describe('amplify add auth...', function () {
    ...
    it('...should init an IOS project and add default auth', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.getAwsIOSConfig)(projRoot)];
                case 4:
                    config = _a.sent();
...
//# sourceMappingURL=auth_1c.test.js.map