...
describe('amplify geo remove', function () {
    ...
    it('init a project with default auth config and multiple geofence collection resources, then remove the default geofence collection', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, collection1Id, collection2Id, collection3Id, cognitoGroups, oldMeta, collection1Name, collection2Name, region, newMeta, awsExport;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    ...
                    collection1Name = oldMeta.geo[collection1Id].output.Name;
                    collection2Name = oldMeta.geo[collection2Id].output.Name;
                    region = oldMeta.geo[collection1Id].output.Region;
                    // remove geofence collection
                    return [4 /*yield*/, (0, amplify_e2e_core_1.removeFirstDefaultGeofenceCollection)(projRoot)];
                case 8:
                    // remove geofence collection
                    _b.sent();
                ...
                case 9:
                    ...
                    expect((0, amplify_e2e_core_1.getGeoJSConfiguration)(awsExport).geofenceCollections.items).not.toContain(collection1Name);
...
//# sourceMappingURL=geo-remove-3.test.js.map