...
describe('transformer @http migration test', function () {
    var projRoot;
    var projectName;
    ...
    it('migration of @http schema', function () { return __awaiter(void 0, void 0, void 0, function () {
        var httpSchema;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    httpSchema = 'transformer_migration/http.graphql';
                    return [4 /*yield*/, (0, amplify_e2e_core_1.addApiWithoutSchema)(projRoot, { apiName: projectName, transformerVersion: 1 })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.updateApiSchema)(projRoot, projectName, httpSchema)];
                case 2:
                    _a.sent();
...
//# sourceMappingURL=http-migration.test.js.map