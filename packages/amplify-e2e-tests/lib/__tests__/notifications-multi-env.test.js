    ...
    it("should add and remove the ".concat(testChannel, " channel correctly when no pinpoint is configured"), function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, (0, env_1.addEnvironment)(projectRoot, { envName: 'prod' })];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, (0, env_1.listEnvironment)(projectRoot, { numEnv: 2 })];
                case 7:
                    _a.sent();
...
//# sourceMappingURL=notifications-multi-env.test.js.map