...
describe('amplify export pull a', function () {
    var projRoot;
    ...
    it('init a js project and compare with export pull', function () { return __awaiter(void 0, void 0, void 0, function () {
        var exportsPath, pathToExportGeneratedConfig;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, amplify_e2e_core_1.initJSProjectWithProfile)(projRoot, { envName: 'dev' })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, AddandPushCategories()];
                case 2:
                    _a.sent();
                    exportsPath = (0, awsExports_1.getAWSExportsPath)(projRoot);
                    return [4 /*yield*/, generatePullConfig('javascript')];
                case 3:
                    pathToExportGeneratedConfig = _a.sent();
...
//# sourceMappingURL=export-pull-a.test.js.map