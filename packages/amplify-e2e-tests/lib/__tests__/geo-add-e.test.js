...
describe('amplify geo add e', function () {
    var projRoot;
    ...
    it('init a project with default auth config and add two place index resources with the second set to default', function () { return __awaiter(void 0, void 0, void 0, function () {
        var index1Id, index2Id, meta, region, index1Name, index2Name, index1, index2, awsExport;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    index1Id = "placeIndex".concat((0, amplify_e2e_core_1.generateRandomShortId)());
                    index2Id = "placeIndex".concat((0, amplify_e2e_core_1.generateRandomShortId)());
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.addPlaceIndexWithDefault)(projRoot, { resourceName: index2Id, isAdditional: true })];
                case 4:
                    _a.sent();
...
//# sourceMappingURL=geo-add-e.test.js.map