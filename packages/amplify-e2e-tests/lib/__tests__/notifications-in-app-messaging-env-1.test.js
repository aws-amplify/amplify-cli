...
describe('notifications in-app with existing pinpoint', function () {
    ...
    it("should add and remove the ".concat(testChannel, " channel correctly with multiple environments"), function () { return __awaiter(void 0, void 0, void 0, function () {
        var pinpointResourceName, settings, appId, meta, inAppMessagingMeta, analyticsMeta, teamInfo, pinpointId, newEnvName, newEnvCloudBackendMeta, newEnvCloudBackendInAppMsgMeta, originalEnvCloudBackendMeta, originalEnvCloudBackendInAppMsgMeta;
...
//# sourceMappingURL=notifications-in-app-messaging-env-1.test.js.map