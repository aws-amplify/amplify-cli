...
describe('amplify export pull d', function () {
    var projRoot;
    ...
    it('init a flutter project and compare with export pull', function () { return __awaiter(void 0, void 0, void 0, function () {
        var amplifyConfigPath, pullConfigPath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, amplify_e2e_core_1.initFlutterProjectWithProfile)(projRoot, { envName: 'dev' })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, AddandPushCategories('flutter')];
                case 2:
                    _a.sent();
                    amplifyConfigPath = path.join(projRoot, 'lib', 'amplifyconfiguration.dart');
                    return [4 /*yield*/, generatePullConfig('flutter')];
                case 3:
...
//# sourceMappingURL=export-pull-d.test.js.map