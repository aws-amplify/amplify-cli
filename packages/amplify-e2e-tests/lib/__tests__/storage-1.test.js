...
describe('amplify add/update storage(S3)', function () {
    ...
    it('init a project and add S3 bucket with Auth user access only', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('init a javascript project and add S3 bucket with guest access', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, amplify_e2e_core_1.initJSProjectWithProfile)(projRoot, {})];
                case 1:
    ...
    it('init a flutter project and add S3 bucket with guest access', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, amplify_e2e_core_1.initFlutterProjectWithProfile)(projRoot, { name: 'storageTest' })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.addAuthWithDefault)(projRoot, {})];
                case 2:
...
//# sourceMappingURL=storage-1.test.js.map