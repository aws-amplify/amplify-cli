...
describe('amplify add hosting - container', function () {
    var projRoot;
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, amplify_e2e_core_1.createNewProjectDir)('container-hosting')];
                case 1:
                    projRoot = _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.initJSProjectWithProfile)(projRoot, {})];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.amplifyConfigureProject)({
                            cwd: projRoot,
    ...
    it.skip('add container hosting works', function () { return __awaiter(void 0, void 0, void 0, function () {
        var projectMeta;
        return __generator(this, function (_a) {
            // TODO: This needs attention. Need to force circle ci to run this test in us-east-1
            expect(fs.existsSync(path.join(projRoot, 'amplify', 'backend', 'hosting', 'ElasticContainer'))).toBe(true);
            projectMeta = (0, amplify_e2e_core_1.getBackendAmplifyMeta)(projRoot);
...
//# sourceMappingURL=container-hosting.test.js.map