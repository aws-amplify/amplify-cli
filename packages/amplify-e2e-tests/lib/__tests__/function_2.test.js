...
describe('nodejs', function () {
    describe('amplify add function with additional permissions', function () {
        ...
        it('lambda with dynamoDB permissions should be able to scan ddb', function () { return __awaiter(void 0, void 0, void 0, function () {
            var random, fnName, ddbName, functionCode, meta, appsyncId, _a, functionArn, functionName, region, result1, payload1, tableName, result2, payload2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, amplify_e2e_core_1.initJSProjectWithProfile)(projRoot, {
                            name: 'dynamodbscan',
                    ...
                    case 1:
                        ...
                        random = (0, amplify_e2e_core_1.generateRandomShortId)();
                        fnName = "integtestfn".concat(random);
                        ddbName = "integtestddb".concat(random);
                    ...
                    case 2:
                        // test ability to scan both appsync @model-backed and regular ddb tables
                        _b.sent();
                        return [4 /*yield*/, (0, amplify_e2e_core_1.updateApiSchema)(projRoot, 'dynamodbscan', 'simple_model.graphql')];
                    case 3:
                        _b.sent();
                    ...
                    case 5:
                        _b.sent();
                        functionCode = (0, amplify_e2e_core_1.loadFunctionTestFile)('dynamodb-scan.js');
                        (0, amplify_e2e_core_1.overrideFunctionSrcNode)(projRoot, fnName, functionCode);
                        return [4 /*yield*/, (0, amplify_e2e_core_1.amplifyPush)(projRoot)];
                    case 6:
                        _b.sent();
                        meta = (0, amplify_e2e_core_1.getProjectMeta)(projRoot);
                        appsyncId = Object.keys(meta.api).map(function (key) { return meta.api[key]; })[0].output.GraphQLAPIIdOutput;
                        _a = Object.keys(meta.function).map(function (key) { return meta.function[key]; })[0].output, functionArn = _a.Arn, functionName = _a.Name, region = _a.Region;
                        expect(appsyncId).toBeDefined();
                        expect(functionName).toBeDefined();
                        expect(region).toBeDefined();
                        return [4 /*yield*/, (0, amplify_e2e_core_1.invokeFunction)(functionName, JSON.stringify({ tableName: "Todo-".concat(appsyncId, "-integtest") }), region)];
                    case 7:
                        result1 = _b.sent();
                        expect(result1.StatusCode).toBe(200);
                        expect(result1.Payload).toBeDefined();
                        payload1 = JSON.parse(result1.Payload.toString());
                        ...
                        tableName = Object.keys(meta.storage).map(function (key) { return meta.storage[key]; })[0].output.Name;
                        return [4 /*yield*/, (0, amplify_e2e_core_1.invokeFunction)(functionName, JSON.stringify({ tableName: tableName }), region)];
                    case 8:
                        result2 = _b.sent();
                        expect(result2.StatusCode).toBe(200);
                        expect(result2.Payload).toBeDefined();
                        payload2 = JSON.parse(result2.Payload.toString());
        ...
        it('existing lambda updated with additional permissions should be able to scan ddb', function () { return __awaiter(void 0, void 0, void 0, function () {
            var appName, fnName, functionCode, meta, _a, functionArn, functionName, region, appsyncId, result, payload;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        it('@model-backed lambda function should generate envvars TODOTABLE_NAME, TODOTABLE_ARN, GRAPHQLAPIIDOUTPUT', function () { return __awaiter(void 0, void 0, void 0, function () {
            var fnName, lambdaSource;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, amplify_e2e_core_1.initJSProjectWithProfile)(projRoot, {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, (0, amplify_e2e_core_1.updateApiSchema)(projRoot, 'modelbackedlambda', 'simple_model.graphql')];
                    case 3:
                        _a.sent();
                        fnName = "integtestfn".concat((0, amplify_e2e_core_1.generateRandomShortId)());
                        return [4 /*yield*/, (0, amplify_e2e_core_1.addFunction)(projRoot, {
                    ...
                    case 4:
                        _a.sent();
                        lambdaSource = (0, amplify_e2e_core_1.getFunctionSrcNode)(projRoot, fnName);
...
//# sourceMappingURL=function_2.test.js.map