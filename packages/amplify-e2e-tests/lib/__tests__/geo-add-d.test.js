...
describe('amplify geo add d', function () {
    var projRoot;
    ...
    it('init a project with default auth config and add two map resources with the second set to default', function () { return __awaiter(void 0, void 0, void 0, function () {
        var map1Id, map2Id, meta, region, map1Name, map2Name, map1, map2, awsExport;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    map1Id = "map".concat((0, amplify_e2e_core_1.generateRandomShortId)());
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.addMapWithDefault)(projRoot, { resourceName: map2Id, isAdditional: true })];
                case 4:
                    _a.sent();
...
//# sourceMappingURL=geo-add-d.test.js.map