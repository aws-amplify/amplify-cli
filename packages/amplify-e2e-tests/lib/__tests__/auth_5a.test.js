...
describe('headless auth a', function () {
    var projRoot;
    ...
    it('adds auth resource', function () { return __awaiter(void 0, void 0, void 0, function () {
        var addAuthRequest, meta, id, userPool;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    addAuthRequest = {
                        ...
                        serviceConfiguration: {
                            ...
                            userPoolConfiguration: {
                                ...
                                signinMethod: amplify_headless_interface_1.CognitoUserPoolSigninMethod.USERNAME,
                            },
                        },
                    };
...
//# sourceMappingURL=auth_5a.test.js.map