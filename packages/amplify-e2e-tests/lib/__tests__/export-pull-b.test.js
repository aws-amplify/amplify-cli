...
describe('amplify export pull b', function () {
    var projRoot;
    ...
    it('init an ios project and compare with export pull', function () { return __awaiter(void 0, void 0, void 0, function () {
        var awsConfigPath, amplifyConfigPath, pullConfigPath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, amplify_e2e_core_1.initIosProjectWithProfile)(projRoot, { envName: 'dev' })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, AddandPushCategories('ios')];
                case 2:
                    _a.sent();
                    awsConfigPath = (0, amplify_e2e_core_1.getAWSConfigIOSPath)(projRoot);
                    amplifyConfigPath = (0, amplify_e2e_core_1.getAmplifyConfigIOSPath)(projRoot);
                    return [4 /*yield*/, generatePullConfig('ios')];
                case 3:
...
//# sourceMappingURL=export-pull-b.test.js.map