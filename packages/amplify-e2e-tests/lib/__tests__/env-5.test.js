...
describe('environment commands with HostedUI params', function () {
    var projRoot;
    ...
    it('init a project, add and checkout environment', function () { return __awaiter(void 0, void 0, void 0, function () {
        var meta;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, env_1.addEnvironmentHostedUI)(projRoot, { envName: 'envb' })];
                case 1:
                    _a.sent();
    ...
    it('init a project, pull environment', function () { return __awaiter(void 0, void 0, void 0, function () {
        var meta;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, env_1.pullEnvironment)(projRoot)];
                case 1:
                    _a.sent();
                    meta = (0, amplify_e2e_core_1.getProjectMeta)(projRoot);
                    return [4 /*yield*/, validate(meta)];
...
//# sourceMappingURL=env-5.test.js.map