...
describe('amplify add api (GraphQL)', function () {
    ...
    it('init a project and add the simple_model api with multiple authorization providers', function () { return __awaiter(void 0, void 0, void 0, function () {
        var appName, meta, output, GraphQLAPIIdOutput, GraphQLAPIEndpointOutput, GraphQLAPIKeyOutput, graphqlApi, cognito, iam, oidc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 5:
                    ...
                    output = meta.api[appName].output;
                ...
                case 6:
                    ...
                    expect(graphqlApi.additionalAuthenticationProviders).toHaveLength(3);
                    cognito = graphqlApi.additionalAuthenticationProviders.filter(function (a) { return a.authenticationType === 'AMAZON_COGNITO_USER_POOLS'; })[0];
                    expect(cognito).toBeDefined();
                    expect(cognito.userPoolConfig).toBeDefined();
                    iam = graphqlApi.additionalAuthenticationProviders.filter(function (a) { return a.authenticationType === 'AWS_IAM'; })[0];
                    expect(iam).toBeDefined();
                    oidc = graphqlApi.additionalAuthenticationProviders.filter(function (a) { return a.authenticationType === 'OPENID_CONNECT'; })[0];
    ...
    it('init a project and add the simple_model api, match transformer version to current version', function () { return __awaiter(void 0, void 0, void 0, function () {
        var name, meta, output, GraphQLAPIIdOutput, GraphQLAPIEndpointOutput, GraphQLAPIKeyOutput, graphqlApi, transformConfig;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    name = "simplemodel".concat((0, amplify_e2e_core_1.generateRandomShortId)());
...
//# sourceMappingURL=api_9.test.js.map