...
describe('amplify add auth...', function () {
    ...
    it('...should init an Android project and add default auth', function () { return __awaiter(void 0, void 0, void 0, function () {
        var config, meta, id, authMeta, clientIds, clients, parameters;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.getAwsAndroidConfig)(projRoot)];
                case 4:
                    config = _a.sent();
                    ...
                    return [4 /*yield*/, (0, amplify_e2e_core_1.getUserPoolClients)(authMeta.output.UserPoolId, clientIds, meta.providers.awscloudformation.Region)];
                case 5:
                    clients = _a.sent();
                    expect(clients[0].UserPoolClient.ClientSecret).toBeUndefined();
                    parameters = (0, amplify_e2e_core_1.getCLIInputs)(projRoot, 'auth', id);
                    parameters.cognitoConfig.userpoolClientGenerateSecret = true;
                    (0, amplify_e2e_core_1.setCLIInputs)(projRoot, 'auth', id, parameters);
                    return [4 /*yield*/, (0, amplify_e2e_core_1.amplifyPushAuth)(projRoot)];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.getAwsAndroidConfig)(projRoot)];
    ...
    it('should init with a long env name and add default auth', function () { return __awaiter(void 0, void 0, void 0, function () {
        var meta, id, userPool;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, amplify_e2e_core_1.initJSProjectWithProfile)(projRoot, __assign(__assign({}, defaultsSettings), { envName: 'longenviro' }))];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.addAuthWithDefault)(projRoot)];
                case 2:
...
//# sourceMappingURL=auth_11.test.js.map