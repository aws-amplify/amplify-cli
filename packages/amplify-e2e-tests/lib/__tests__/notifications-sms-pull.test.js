...
describe('notification category pull test', function () {
    var testChannel = 'SMS';
    ...
    it("should add and remove the ".concat(testChannel, " channel and pull in new directory"), function () { return __awaiter(void 0, void 0, void 0, function () {
        var settings, appId, projectRootPull;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.createNewProjectDir)('removed-notifications-pull')];
                case 4:
...
//# sourceMappingURL=notifications-sms-pull.test.js.map