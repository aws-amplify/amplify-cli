...
describe('amplify geo add c', function () {
    var projRoot;
    ...
    it('init a project with default auth config and add the geofence collection resource', function () { return __awaiter(void 0, void 0, void 0, function () {
        var cognitoGroups, meta, collectionId, collectionName, region, collection, awsExport;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
//# sourceMappingURL=geo-add-c.test.js.map