...
describe('runtime hooks', function () {
    ...
    it('test hook scripts with non zero exit code', function () { return __awaiter(void 0, void 0, void 0, function () {
        var hooksDirPath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                ...
                case 1:
                    ...
                    return [4 /*yield*/, expect((0, amplify_e2e_core_1.addFunction)(projRoot, { functionTemplate: 'Hello World' }, 'nodejs')).rejects.toThrow()];
                case 2:
                    // amplify process should exit as the hook script exited with non zero exit code
                    _a.sent();
...
//# sourceMappingURL=hooks-b.test.js.map