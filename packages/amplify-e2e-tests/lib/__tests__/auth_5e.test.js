...
describe('headless auth e', function () {
    var projRoot;
    ...
    it('updates existing auth resource', function () { return __awaiter(void 0, void 0, void 0, function () {
        var updateAuthRequest, meta, id, userPool;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    updateAuthRequest = {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, amplify_e2e_core_1.updateHeadlessAuth)(projRoot, updateAuthRequest, {})];
                case 3:
                    _a.sent();
                ...
                case 5:
                    ...
                    expect(lodash_1.default.get(meta, ['auth', 'userPoolGroups'])).toBeDefined();
                    return [2 /*return*/];
            }
        });
    }); });
});
//# sourceMappingURL=auth_5e.test.js.map