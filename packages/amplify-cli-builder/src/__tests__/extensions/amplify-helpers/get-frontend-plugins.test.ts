...
describe('get-frontend-plugins', () => {
  it('returns map of frontend plugins when frontend plugin exists', () => {
        ...
        plugins: [
          {
            ...
            directory: '/home/user/amplify/lib/@aws-amplify/cli-builder/node_modules/amplify-frontend-javascript',
          },
          {
            name: 'amplify-frontend-flutter',
            pluginType: 'frontend',
            pluginName: 'flutter',
            directory: '/home/user/amplify/lib/@aws-amplify/cli-builder/node_modules/amplify-frontend-flutter',
          },
          {
            name: '@aws-amplify/amplify-category-auth',
            pluginType: 'category',
            pluginName: 'auth',
            directory: '/home/user/amplify/lib/@aws-amplify/cli-builder/node_modules/@aws-amplify/amplify-category-auth',
          },
        ],
      },
    };
    ...
    expect(plugins).toEqual({
      javascript: '/home/user/amplify/lib/@aws-amplify/cli-builder/node_modules/amplify-frontend-javascript',
      flutter: '/home/user/amplify/lib/@aws-amplify/cli-builder/node_modules/amplify-frontend-flutter',
    });
  });
