...
var ResourceFactory = /** @class */ (function () {
    ...
    ResourceFactory.prototype.makeDynamoDBStreamEventSourceMapping = function (typeName) {
        return new cloudform_1.Lambda.EventSourceMapping({
            BatchSize: 1,
            Enabled: true,
            EventSourceArn: cloudform_1.Fn.GetAtt(graphql_transformer_common_1.ModelResourceIDs.ModelTableResourceID(typeName), 'StreamArn'),
            ...
            .dependsOn(graphql_transformer_common_1.ModelResourceIDs.ModelTableResourceID(typeName))
    ...
    ResourceFactory.prototype.makeSearchResolver = function (type, nameOverride) {
        ...
        return new appSync_1.default.Resolver({
            ...
            ])), { 'ddbTableName': cloudform_1.Fn.Ref(graphql_transformer_common_1.ModelResourceIDs.ModelTableResourceID(type)) }),
