...
export default class AmplifyToolkit {
  ...
  get pathManager(): any {
    this._pathManager = this._pathManager ||
            require(path.join(this._amplifyHelpersDirPath, 'path-manager'));
    return this._pathManager;
  }
  get pressEnterToContinue(): any {
    this._pressEnterToContinue = this._pressEnterToContinue ||
            require(path.join(this._amplifyHelpersDirPath, 'press-enter-to-continue'));
    return this._pressEnterToContinue;
  }
  get pushResources(): any {
    this._pushResources = this._pushResources ||
            require(path.join(this._amplifyHelpersDirPath, 'push-resources')).pushResources;
    return this._pushResources;
  }
  get readJsonFile(): any {
    this._readJsonFile = this._readJsonFile ||
            require(path.join(this._amplifyHelpersDirPath, 'read-json-file')).readJsonFile;
    return this._readJsonFile;
  }
  get removeEnvFromCloud(): any {
    this._removeEnvFromCloud = this._removeEnvFromCloud ||
            require(path.join(this._amplifyHelpersDirPath, 'remove-env-from-cloud')).removeEnvFromCloud;
    return this._removeEnvFromCloud;
  }
  get removeResource(): any {
    this._removeResource = this._removeResource ||
            require(path.join(this._amplifyHelpersDirPath, 'remove-resource')).removeResource;
    return this._removeResource;
  }
  get sharedQuestions(): any {
    this._sharedQuestions = this._sharedQuestions ||
            require(path.join(this._amplifyHelpersDirPath, 'shared-questions')).sharedQuestions;
    return this._sharedQuestions;
  }
  get showHelp(): any {
    this._showHelp = this._showHelp ||
            require(path.join(this._amplifyHelpersDirPath, 'show-help')).showHelp;
    return this._showHelp;
  }
  get showAllHelp(): any {
    this._showAllHelp = this._showAllHelp ||
            require(path.join(this._amplifyHelpersDirPath, 'show-all-help')).showAllHelp;
  ...
  get showResourceTable(): any {
    this._showResourceTable = this._showResourceTable ||
            require(path.join(this._amplifyHelpersDirPath, 'resource-status')).showResourceTable;
    return this._showResourceTable;
  }
  get serviceSelectionPrompt(): any {
    this._serviceSelectionPrompt = this._serviceSelectionPrompt ||
            require(path.join(this._amplifyHelpersDirPath, 'service-select-prompt')).serviceSelectionPrompt;
    return this._serviceSelectionPrompt;
  }
  get updateProjectConfig(): any {
    this._updateProjectConfig = this._updateProjectConfig ||
            require(path.join(this._amplifyHelpersDirPath, 'update-project-config')).updateProjectConfig;
  ...
  get updateProvideramplifyMeta(): any {
    this._updateProvideramplifyMeta = this._updateProvideramplifyMeta ||
            require(path.join(this._amplifyHelpersDirPath, 'update-amplify-meta')).updateProvideramplifyMeta;
  ...
  get updateamplifyMetaAfterPush(): any {
    this._updateamplifyMetaAfterPush = this._updateamplifyMetaAfterPush ||
            require(path.join(this._amplifyHelpersDirPath, 'update-amplify-meta')).updateamplifyMetaAfterPush;
  ...
  get loadEnvResourceParameters(): any {
    this._loadEnvResourceParameters = this._loadEnvResourceParameters ||
            require(path.join(this._amplifyHelpersDirPath, 'envResourceParams')).loadEnvResourceParameters;
  ...
  get saveEnvResourceParameters(): any {
    this._saveEnvResourceParameters = this._saveEnvResourceParameters ||
            require(path.join(this._amplifyHelpersDirPath, 'envResourceParams')).saveEnvResourceParameters;
  ...
  get removeResourceParameters(): any {
    this._removeResourceParameters = this._removeResourceParameters ||
            require(path.join(this._amplifyHelpersDirPath, 'envResourceParams')).removeResourceParameters;
    return this._removeResourceParameters;
  }

  get triggerFlow(): any {
    this._triggerFlow = this._triggerFlow ||
            require(path.join(this._amplifyHelpersDirPath, 'trigger-flow')).triggerFlow;
    return this._triggerFlow;
  }
  get addTrigger(): any {
    this._addTrigger = this._addTrigger ||
            require(path.join(this._amplifyHelpersDirPath, 'trigger-flow')).addTrigger;
    return this._addTrigger;
  }
  get updateTrigger(): any {
    this._updateTrigger = this._updateTrigger ||
            require(path.join(this._amplifyHelpersDirPath, 'trigger-flow')).updateTrigger;
    return this._updateTrigger;
  }
  get deleteTrigger(): any {
    this._deleteTrigger = this._deleteTrigger ||
            require(path.join(this._amplifyHelpersDirPath, 'trigger-flow')).deleteTrigger;
    return this._deleteTrigger;
  }
  get deleteAllTriggers(): any {
    this._deleteAllTriggers = this._deleteAllTriggers ||
            require(path.join(this._amplifyHelpersDirPath, 'trigger-flow')).deleteAllTriggers;
  ...
  get getTriggerEnvVariables(): any {
    this._getTriggerEnvVariables = this._getTriggerEnvVariables ||
            require(path.join(this._amplifyHelpersDirPath, 'trigger-flow')).getTriggerEnvVariables;
    return this._getTriggerEnvVariables;
  }
  get getTriggerEnvInputs(): any {
    this._getTriggerEnvInputs = this._getTriggerEnvInputs ||
            require(path.join(this._amplifyHelpersDirPath, 'trigger-flow')).getTriggerEnvInputs;
