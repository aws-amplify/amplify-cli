import { $TSAny, AmplifyException, AmplifyFaultType, AmplifyFault, executeHooks, HooksMeta } from "amplify-cli-core";
...
const mapNodeErrorToResolution = (__err: NodeJS.ErrnoException): string =>
