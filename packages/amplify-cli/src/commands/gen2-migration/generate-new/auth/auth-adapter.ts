// Auth adapter - converts Cognito SDK types to AuthDefinition
// Duplicated from generate/adapters/auth/index.ts for generate-new/ self-containment
import {
  AuthDefinition,
  EmailOptions,
  PasswordPolicyPath,
...
/**
 * Converts Gen 1 Cognito auth configuration to Gen 2 AuthDefinition format.
 */
