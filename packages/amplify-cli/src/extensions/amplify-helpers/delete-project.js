...
async function deleteProject(context) {
  return context.amplify.confirmPrompt('Are you sure you want to continue?(This would delete all the project from the cloud and wipe out all the local amplify resource files)')
    .then((answer) => {
      if (answer) {
