...
function removeResource(context, category) {
  ...
  return inquirer.prompt(question)
    .then((answer) => {
      ...
      return context.amplify.confirmPrompt('Are you sure you want to delete the resource? This action deletes all files related to this resource from the backend directory.')
        .then(async (confirm) => {
          if (confirm) {
