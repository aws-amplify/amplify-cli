...
jest.mock('../../../../../../commands/gen2-migration/generate-new/output/auth/auth.renderer', () => {
  const actual = jest.requireActual('../../../../../../commands/gen2-migration/generate-new/output/auth/auth.renderer');
...
jest.mock('../../../../../../commands/gen2-migration/generate-new/output/auth/reference-auth.renderer', () => {
  const actual = jest.requireActual('../../../../../../commands/gen2-migration/generate-new/output/auth/reference-auth.renderer');
  return {
    ...actual,
