...
import { RenderDefineFunctionOptions } from '../../../../../../commands/gen2-migration/generate-new/output/functions/function.renderer';
...
jest.mock('../../../../../../commands/gen2-migration/generate-new/output/functions/function.renderer', () => {
  const actual = jest.requireActual('../../../../../../commands/gen2-migration/generate-new/output/functions/function.renderer');
  return {
    ...actual,
