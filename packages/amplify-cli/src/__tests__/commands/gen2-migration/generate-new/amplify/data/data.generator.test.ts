...
import { DataGenerator } from '../../../../../../commands/gen2-migration/generate-new/amplify/data/data.generator';
...
import { DataRenderer, RenderDefineDataOptions } from '../../../../../../commands/gen2-migration/generate-new/amplify/data/data.renderer';

jest.unmock('fs-extra');

const mockRender = jest.fn().mockReturnValue(ts.factory.createNodeArray([]));
jest.mock('../../../../../../commands/gen2-migration/generate-new/amplify/data/data.renderer', () => ({
