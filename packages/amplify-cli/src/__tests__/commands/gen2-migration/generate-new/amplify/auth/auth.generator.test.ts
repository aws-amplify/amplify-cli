...
import { AuthGenerator } from '../../../../../../commands/gen2-migration/generate-new/amplify/auth/auth.generator';
import { ReferenceAuthGenerator } from '../../../../../../commands/gen2-migration/generate-new/amplify/auth/reference-auth.generator';
...
jest.mock('../../../../../../commands/gen2-migration/generate-new/amplify/auth/auth.renderer', () => {
  const actual = jest.requireActual('../../../../../../commands/gen2-migration/generate-new/amplify/auth/auth.renderer');
...
jest.mock('../../../../../../commands/gen2-migration/generate-new/amplify/auth/reference-auth.renderer', () => {
  const actual = jest.requireActual('../../../../../../commands/gen2-migration/generate-new/amplify/auth/reference-auth.renderer');
  return {
    ...actual,
