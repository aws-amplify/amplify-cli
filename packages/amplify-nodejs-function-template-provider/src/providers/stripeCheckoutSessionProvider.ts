...
const pathToTemplateFiles = path.join(templateRoot, 'lambda/stripe-checkout-session');

export function provideStripeCheckoutSession(): Promise<FunctionTemplateParameters> {
