...
describe('api lambda migration tests', () => {
    ...
    it('...adds lambda with multiple rest APIs with v10 and pulls without drift in latest version', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, amplify_e2e_core_1.addFunction)(projRoot, { functionTemplate: 'Hello World' }, 'nodejs');
        yield (0, amplify_e2e_core_1.addRestApi)(projRoot, {
            existingLambda: true,
            restrictAccess: true,
        ...
        yield (0, amplify_e2e_core_1.addRestApi)(projRoot, { isFirstRestApi: false, existingLambda: true });
        yield (0, amplify_e2e_core_1.updateAuthAddAdminQueries)(projRoot, undefined, {});
        ...
        try {
            ...
            expect(yield (0, amplify_e2e_core_1.listRolePolicies)(AuthRoleName, Region)).toEqual([]);
            expect(yield (0, amplify_e2e_core_1.listRolePolicies)(UnauthRoleName, Region)).toEqual([]);
            // there should be some managed policies attached to the roles
            const authPolicies = yield (0, amplify_e2e_core_1.listAttachedRolePolicies)(AuthRoleName, Region);
            ...
            const unauthPolicies = yield (0, amplify_e2e_core_1.listAttachedRolePolicies)(UnauthRoleName, Region);
...
//# sourceMappingURL=api-rest-lambda.migration.test.js.map