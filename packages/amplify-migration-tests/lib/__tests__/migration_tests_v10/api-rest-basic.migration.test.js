...
describe('api REST migration tests', () => {
    ...
    it('...adds rest APIs & DDB with v10 and pulls without drift in latest version', () => __awaiter(void 0, void 0, void 0, function* () {
        projectName = 'restDDB';
        projRoot = yield (0, amplify_e2e_core_1.createNewProjectDir)(projectName);
        const randomId = yield (0, amplify_e2e_core_1.generateRandomShortId)();
        ...
        yield (0, amplify_e2e_core_1.addSimpleDDB)(projRoot, { name: DDB_NAME });
        yield (0, amplify_e2e_core_1.addRestApi)(projRoot, { isCrud: true, projectContainsFunctions: false });
...
//# sourceMappingURL=api-rest-basic.migration.test.js.map