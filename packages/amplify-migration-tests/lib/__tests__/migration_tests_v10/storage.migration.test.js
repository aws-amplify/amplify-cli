...
describe('storage category migration from v10 to latest', () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, init_1.initJSProjectWithProfileV10)(projRoot, { name: 'storageMigration', disableAmplifyAppCreation: false });
        yield (0, amplify_e2e_core_1.addDynamoDBWithGSIWithSettings)(projRoot, {
            resourceName: `${projectName}res${(0, utils_1.getShortId)()}`,
            tableName: `${projectName}tbl${(0, utils_1.getShortId)()}`,
            gsiName: `${projectName}gsi${(0, utils_1.getShortId)()}`,
        });
        yield (0, amplify_e2e_core_1.addDDBWithTrigger)(projRoot, {});
        yield (0, amplify_e2e_core_1.addAuthWithDefault)(projRoot);
        yield (0, amplify_e2e_core_1.addS3StorageWithSettings)(projRoot, {});
...
//# sourceMappingURL=storage.migration.test.js.map