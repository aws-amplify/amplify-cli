...
describe('amplify auth migration', () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        projRoot = yield (0, amplify_e2e_core_1.createNewProjectDir)('auth migration');
        ...
        yield (0, migration_helpers_1.initJSProjectWithProfileV4_52_0)(projRoot, { name: 'authMigration' });
    }));
...
//# sourceMappingURL=auth_migration_update.test.js.map