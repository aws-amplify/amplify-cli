...
describe('amplify add notifications', () => {
    ...
    it('should add in app notifications if analytics then another notification channel and auth added and pushed with an older version', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, amplify_e2e_core_1.addAuthWithDefault)(projectRoot, false);
...
//# sourceMappingURL=notifications-migration-5.test.js.map