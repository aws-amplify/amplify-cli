...
describe('amplify add notifications', () => {
    ...
    it('should add in app notifications if analytics then another notification channel added and pushed with an older version', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, notifications_helpers_1.addLegacySmsNotificationChannel)(projectRoot, settings.resourceName, true);
...
//# sourceMappingURL=notifications-migration-3.test.js.map