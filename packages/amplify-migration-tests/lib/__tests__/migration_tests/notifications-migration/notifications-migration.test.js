...
describe('amplify add notifications', () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        projectRoot = yield (0, amplify_e2e_core_1.createNewProjectDir)('init');
    ...
    it('should add in app notifications if analytics added with an older version', () => __awaiter(void 0, void 0, void 0, function* () {
        expect(migrateFromVersion.v).not.toEqual(migrateToVersion.v);
        yield (0, migration_helpers_1.initJSProjectWithProfileV4_52_0)(projectRoot, {}, false);
        yield (0, amplify_e2e_core_1.addPinpointAnalytics)(projectRoot, false);
    ...
    it('should add in app notifications if analytics added and pushed with an older version', () => __awaiter(void 0, void 0, void 0, function* () {
        expect(migrateFromVersion.v).not.toEqual(migrateToVersion.v);
        yield (0, migration_helpers_1.initJSProjectWithProfileV4_52_0)(projectRoot, {}, false);
        yield (0, amplify_e2e_core_1.addPinpointAnalytics)(projectRoot, false);
...
//# sourceMappingURL=notifications-migration.test.js.map