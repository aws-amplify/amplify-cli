...
describe('api migration update test d', () => {
    ...
    const addApiRequest = {
        ...
        serviceConfiguration: {
            serviceName: 'AppSync',
            apiName: 'myApiName',
            transformSchema: fs.readFileSync((0, amplify_e2e_core_1.getSchemaPath)('simple_model.graphql'), 'utf8'),
            defaultAuthType: {
                mode: 'API_KEY',
            },
        },
    ...
    const updateApiRequest = {
        ...
        serviceModification: {
            serviceName: 'AppSync',
            transformSchema: fs.readFileSync((0, amplify_e2e_core_1.getSchemaPath)('simple_model_override.graphql'), 'utf8'),
            defaultAuthType: {
                mode: 'AWS_IAM',
            },
            additionalAuthTypes: [
    ...
    it('updates AppSync API in headless mode', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, migration_helpers_1.initJSProjectWithProfileV4_52_0)(projRoot, {});
        yield (0, amplify_e2e_core_1.addHeadlessApi)(projRoot, addApiRequest, {
            allowDestructiveUpdates: false,
            testingWithLatestCodebase: false,
        });
        yield (0, amplify_e2e_core_1.amplifyPushLegacy)(projRoot);
        yield (0, amplify_e2e_core_1.updateHeadlessApi)(projRoot, updateApiRequest, true, { testingWithLatestCodebase: true });
        expect((0, amplify_e2e_core_1.getCLIInputs)(projRoot, 'api', 'myApiName')).toBeDefined();
        yield (0, amplify_e2e_core_1.amplifyPushUpdateLegacy)(projRoot, undefined, true);
        // verify
...
//# sourceMappingURL=api-migration-d.test.js.map