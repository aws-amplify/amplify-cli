...
const api_1 = require("../../../migration-helpers/api");
...
describe('API Gateway CDK migration', () => {
    ...
    it('migrates on api update', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, api_1.addRestApiOldDx)(projRoot, { existingLambda: false, apiName: 'restapimig' });
        yield (0, amplify_e2e_core_1.amplifyPushAuthV5V6)(projRoot);
        yield (0, amplify_e2e_core_1.updateRestApi)(projRoot, {
        ...
        const cliInputs = (0, amplify_e2e_core_1.getCLIInputs)(projRoot, 'api', 'restapimig');
        expect(cliInputs).toBeDefined();
    }));
});
//# sourceMappingURL=apigw-ext-migration.test.js.map