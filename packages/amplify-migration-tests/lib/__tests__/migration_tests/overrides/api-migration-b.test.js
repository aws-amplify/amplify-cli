...
describe('api migration update test b', () => {
    ...
    it('allows api updates without api migration', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, amplify_e2e_core_1.updateApiWithMultiAuth)(projRoot, { testingWithLatestCodebase: true, doMigrate: false });
        // cli-inputs should not exist
        expect((0, amplify_e2e_core_1.cliInputsExists)(projRoot, 'api', 'simplemodelmultiauth')).toBe(false);
...
//# sourceMappingURL=api-migration-b.test.js.map