...
describe('amplify key force push', () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, migration_helpers_1.initJSProjectWithProfileV4_52_0)(projRoot, { name: 'gqlkeytwomigration' });
    }));
    afterEach(() => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, amplify_e2e_core_1.deleteProject)(projRoot, null, true);
        (0, amplify_e2e_core_1.deleteProjectDir)(projRoot);
    }));
    it('init project, add lsi key and force push expect error', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // add feature flag
        (0, amplify_e2e_core_1.addFeatureFlag)(projRoot, 'graphqltransformer', 'secondaryKeyAsGSI', true);
        // forceUpdateSchema
        (0, amplify_e2e_core_1.updateApiSchema)(projRoot, projectName, initialSchema, true);
        // gql-compile and force push with codebase cli
        yield expect((0, amplify_e2e_core_1.amplifyPushUpdate)(projRoot, /Attempting to remove a local secondary index on the TodoTable table in the Todo stack.*/, true)).rejects.toThrowError(/Attempting to remove a local secondary index on the TodoTable table in the Todo stack.*/);
    }));
});
//# sourceMappingURL=api.key.migration-2.test.js.map