...
exports.addRestApiOldDx = exports.addApiWithSchemaAndConflictDetectionOldDx = exports.addApiWithoutSchemaOldDx = void 0;
 ...
 */
function addApiWithoutSchemaOldDx(cwd, opts = {}) {
    const options = (0, lodash_1.assign)(amplify_e2e_core_1.defaultOptions, opts);
    return new Promise((resolve, reject) => {
        (0, amplify_e2e_core_1.nspawn)((0, amplify_e2e_core_1.getCLIPath)(), ['add', 'api'], { cwd, stripColors: true })
...
exports.addApiWithoutSchemaOldDx = addApiWithoutSchemaOldDx;
function addApiWithSchemaAndConflictDetectionOldDx(cwd, schemaFile) {
    const schemaPath = (0, amplify_e2e_core_1.getSchemaPath)(schemaFile);
    return new Promise((resolve, reject) => {
        (0, amplify_e2e_core_1.nspawn)((0, amplify_e2e_core_1.getCLIPath)(), ['add', 'api'], { cwd, stripColors: true })
            .wait('Please select from one of the below mentioned services:')
            .sendCarriageReturn()
            ...
            .sendCarriageReturn()
            .wait(/.*Do you want to configure advanced settings for the GraphQL API.*/)
            .sendLine(amplify_e2e_core_1.KEY_DOWN_ARROW) // Down
...
exports.addApiWithSchemaAndConflictDetectionOldDx = addApiWithSchemaAndConflictDetectionOldDx;
function addRestApiOldDx(cwd, settings) {
    var _a;
    const isFirstRestApi = (_a = settings.isFirstRestApi) !== null && _a !== void 0 ? _a : true;
    const chain = (0, amplify_e2e_core_1.nspawn)((0, amplify_e2e_core_1.getCLIPath)(), ['add', 'api'], { cwd, stripColors: true })
    ...
    if (settings.existingLambda) {
        ...
        chain
            ...
            .sendCarriageReturn();
        (0, amplify_e2e_core_1.selectRuntime)(chain, 'nodejs');
        const templateName = settings.isCrud
            ? 'CRUD function for DynamoDB (Integration with API Gateway)'
            : 'Serverless ExpressJS function (Integration with API Gateway)';
        (0, amplify_e2e_core_1.selectTemplate)(chain, templateName, 'nodejs');
        if (settings.isCrud) {
            chain
...
exports.addRestApiOldDx = addRestApiOldDx;
