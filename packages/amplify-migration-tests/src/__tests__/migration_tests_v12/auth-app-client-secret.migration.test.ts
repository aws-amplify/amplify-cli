...
import { initIosProjectWithProfileV12 } from '../../migration-helpers-v12/init';
...
describe('v12: amplify add auth...', () => {
  ...
  beforeEach(async () => {
    ...
    await initIosProjectWithProfileV12(projRoot, defaultsSettings);
