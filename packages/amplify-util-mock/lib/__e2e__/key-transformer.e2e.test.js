...
async function createItem(orderId, status, name, createdAt = new Date().toISOString()) {
    ...
    (0, index_1.logDebug)(`Running create: ${JSON.stringify(input)}`);
    (0, index_1.logDebug)(JSON.stringify(result, null, 4));
    return result;
}
...
async function deleteItem(orderId, status, createdAt) {
    ...
    (0, index_1.logDebug)(`Running delete: ${JSON.stringify(input)}`);
    (0, index_1.logDebug)(JSON.stringify(result, null, 4));
    return result;
}
...
async function updateShippingUpdate(input) {
    ...
    (0, index_1.logDebug)(`Running update: ${JSON.stringify(input)}`);
    (0, index_1.logDebug)(JSON.stringify(result, null, 4));
    return result;
}
