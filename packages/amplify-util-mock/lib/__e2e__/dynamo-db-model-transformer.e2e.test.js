...
afterEach(async () => {
    try {
        (0, index_1.logDebug)('deleting posts');
...
test('Test updatePost mutation', async () => {
    try {
        ...
        (0, index_1.logDebug)(JSON.stringify(createResponse, null, 4));
        expect(createResponse.data.createPost.id).toBeDefined();
        ...
        (0, index_1.logDebug)(JSON.stringify(updateResponse, null, 4));
...
test('Test createPost and updatePost mutation with a client generated id.', async () => {
    try {
        ...
        (0, index_1.logDebug)(JSON.stringify(deleteResponse, null, 4));
        ...
        (0, index_1.logDebug)(JSON.stringify(getResponse2, null, 4));
...
test('Test listPosts query with filter', async () => {
    try {
        ...
        (0, index_1.logDebug)(JSON.stringify(listWithFilterResponse, null, 4));
...
test('Test enum filters List', async () => {
    try {
      ...
      `, {});
        (0, index_1.logDebug)(JSON.stringify(appearsInWithFilterResponseNonJedi));
