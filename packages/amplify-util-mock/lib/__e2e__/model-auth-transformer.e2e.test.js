...
beforeAll(async () => {
    ...
    try {
        ...
        const accessToken = (0, cognito_utils_1.signUpAddToGroupAndGetJwtToken)(USER_POOL_ID, USERNAME1, USERNAME1, [ADMIN_GROUP_NAME, PARTICIPANT_GROUP_NAME, WATCHER_GROUP_NAME], 'access');
        ...
        const idToken3 = (0, cognito_utils_1.signUpAddToGroupAndGetJwtToken)(USER_POOL_ID, USERNAME2, USERNAME3, []);
...
test('Test createPost mutation', async () => {
    ...
    (0, index_1.logDebug)('Using access token based client\n');
...
test('Test getPost query when authorized', async () => {
    ...
    (0, index_1.logDebug)(getResponse);
...
test('Test updatePost mutation when not authorized', async () => {
    ...
    (0, index_1.logDebug)(updateResponse);
...
test('Test listPosts query when authorized', async () => {
    ...
    (0, index_1.logDebug)(JSON.stringify(listResponse, null, 4));
    ...
    (0, index_1.logDebug)(JSON.stringify(listResponseAccess, null, 4));
...
test(`Test update my own salary without admin permission`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(req, null, 4));
    expect(req.data.createSalary.wage).toEqual(10);
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(req2, null, 4));
...
test(`Test updating someone else's salary when I am not admin.`, async () => {
    ...
    expect(req2.errors[0].data).toBeNull();
...
test(`Test listPWProtecteds when the user is authorized.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(uReq, null, 4));
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(req3, null, 4));
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(dReq, null, 4));
...
test(`Test Protecteds when the user is not authorized.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(getReq, null, 4));
...
test(`Test creating, updating, and deleting an admin note as a non admin`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(adminReq, null, 4));
...
test(`Test getAllThree as admin.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedBy2, null, 4));
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(fetchOwnedBy2AsAdmin, null, 4));
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(deleteReq, null, 4));
...
test(`Test getAllThree as owner.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(fetchOwnedBy2AsOwner, null, 4));
...
test(`Test getAllThree as one of a set of editors.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(fetchOwnedBy2AsEditor, null, 4));
...
test(`Test getAllThree as a member of a dynamic group.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedByAdmins, null, 4));
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(fetchOwnedByAdminsAsAdmin, null, 4));
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(fetchOwnedByAdminsAsNonAdmin, null, 4));
...
test(`Test createAllThree as admin.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedBy2NoEditors, null, 4));
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(deleteReq2, null, 4));
...
test(`Test createAllThree as owner.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedBy1, null, 4));
...
test(`Test createAllThree as one of a set of editors.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedBy2WithDefaultOwner, null, 4));
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedByEditorsUnauthed, null, 4));
...
test(`Test createAllThree as a member of a dynamic group.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedByDevs, null, 4));
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedByAdminsUnauthed, null, 4));
...
test(`Test updateAllThree and deleteAllThree as admin.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedByTwoUpdate, null, 4));
...
test(`Test updateAllThree and deleteAllThree as owner.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedBy2Update, null, 4));
...
test(`Test updateAllThree and deleteAllThree as one of a set of editors.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedByUpdate, null, 4));
...
test(`Test updateAllThree and deleteAllThree as a member of the alternative group.`, async () => {
    ...
    (0, index_1.logDebug)(JSON.stringify(ownedByAdminsUnauthed, null, 4));
    expect(ownedByAdminsUnauthed.errors.length).toEqual(1);
    expect(ownedByAdminsUnauthed.errors[0].data).toBeNull();
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(ownedByDevs2, null, 4));
...
test(`Test createTestIdentity as admin.`, async () => {
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(update, null, 4));
    ...
    `);
    (0, index_1.logDebug)(JSON.stringify(delReq, null, 4));
