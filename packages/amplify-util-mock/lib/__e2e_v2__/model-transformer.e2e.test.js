...
describe('@model transformer', () => {
      ...
      enum Episode {
        ...
        try {
            const transformer = new graphql_transformer_core_1.GraphQLTransform({
                transformers: [new graphql_model_transformer_1.ModelTransformer(), new graphql_auth_transformer_1.AuthTransformer()],
                featureFlags: {
    ...
    afterEach(async () => {
        try {
            (0, utils_1.logDebug)('deleting posts');
    ...
    test('updatePost mutation', async () => {
        ...
        (0, utils_1.logDebug)(JSON.stringify(createResponse, null, 4));
        expect(createResponse.data.createPost.id).toBeDefined();
        ...
        (0, utils_1.logDebug)(JSON.stringify(updateResponse, null, 4));
    ...
    test('createPost and updatePost mutation with a client generated id.', async () => {
        ...
        (0, utils_1.logDebug)(JSON.stringify(getResponse, null, 4));
        ...
        (0, utils_1.logDebug)(JSON.stringify(deleteResponse, null, 4));
        ...
        (0, utils_1.logDebug)(JSON.stringify(getResponse2, null, 4));
    ...
    test('listPosts query with filter', async () => {
        ...
        (0, utils_1.logDebug)(JSON.stringify(listWithFilterResponse, null, 4));
    ...
    test('enum filters List', async () => {
        ...
        const appearsInWithFilterResponseJedi = await GRAPHQL_CLIENT.query(`query {
        ...
        (0, utils_1.logDebug)(items);
        expect(items.length).toEqual(1);
        expect(items[0].title).toEqual('Appears in Jedi');
        const appearsInWithFilterResponseNonJedi = await GRAPHQL_CLIENT.query(`query {
        ...
        `, {});
        (0, utils_1.logDebug)(JSON.stringify(appearsInWithFilterResponseNonJedi));
        ...
        const appearsInContainingJedi = await GRAPHQL_CLIENT.query(`query {
        ...
        const appearsInNotContainingJedi = await GRAPHQL_CLIENT.query(`query {
        ...
        const jediEpisode = await GRAPHQL_CLIENT.query(`query {
        ...
        const nonJediEpisode = await GRAPHQL_CLIENT.query(`query {
...
//# sourceMappingURL=model-transformer.e2e.test.js.map