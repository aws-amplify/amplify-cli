...
function _load_pattern_prompt() {
  return (_pattern_prompt = _interopRequireDefault(
    require('./pattern_prompt')
  ));
}
...
class TestNamePatternPrompt extends (_pattern_prompt || _load_pattern_prompt())
  .default {
  ...
  _printPrompt(pattern, options) {
    ...
    (0,
    (_pattern_mode_helpers || _load_pattern_mode_helpers()).printPatternCaret)(
      pattern,
      pipe
    );
    (0,
    (_pattern_mode_helpers || _load_pattern_mode_helpers())
