...
var DynamoDBMappingTemplate = /** @class */ (function () {
    ...
    DynamoDBMappingTemplate.query = function (_a) {
        var query = _a.query, filter = _a.filter, scanIndexForward = _a.scanIndexForward, limit = _a.limit, nextToken = _a.nextToken;
        return ast_1.obj({
            version: ast_1.str('2017-02-28'),
    ...
    DynamoDBMappingTemplate.updateItem = function (_a) {
        ...
        return ast_1.compoundExpression([
            ast_1.iff(ast_1.raw('!$input'), ast_1.set(ast_1.ref('input'), ast_1.ref('util.map.copyAndRemoveAllKeys($context.args.input, [])'))),
            ...
            ast_1.forEach(ast_1.ref('entry'), ast_1.ref("util.map.copyAndRemoveAllKeys($input, [" + keyNames.map(function (k) { return "\"" + k + "\""; }).join(', ') + "]).entrySet()"), [
