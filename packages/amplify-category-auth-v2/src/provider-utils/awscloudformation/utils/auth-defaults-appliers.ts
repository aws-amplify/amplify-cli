...
export const getAddAuthDefaultsApplier = (context: any, defaultValuesFilename: string, projectName: string) => async (
  result: CognitoCLIInputs,
): Promise<CognitoCLIInputs> => {
...
export const getUpdateAuthDefaultsApplier = (context: any, defaultValuesFilename: string, previousResult: CognitoCLIInputs) => async (
  result: CognitoCLIInputs,
): Promise<CognitoCLIInputs> => {
