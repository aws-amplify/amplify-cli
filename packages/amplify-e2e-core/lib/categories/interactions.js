...
exports.updateInteractions = exports.addInteractionsWithBotFromScratch = exports.addSampleInteraction = void 0;
const __1 = require("..");
const addSampleInteraction = (cwd) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'interactions'], { cwd, stripColors: true })
...
exports.addSampleInteraction = addSampleInteraction;
const addInteractionsWithBotFromScratch = (cwd, settings) => __awaiter(void 0, void 0, void 0, function* () {
    const chain = (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'interactions'], { cwd, stripColors: true });
    return chain
...
exports.addInteractionsWithBotFromScratch = addInteractionsWithBotFromScratch;
const updateInteractions = (cwd, settings) => __awaiter(void 0, void 0, void 0, function* () {
    const chain = (0, __1.nspawn)((0, __1.getCLIPath)(), ['update', 'interactions'], { cwd, stripColors: true });
    return chain
...
exports.updateInteractions = updateInteractions;
