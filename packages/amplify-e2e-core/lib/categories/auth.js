...
exports.updateAuthWithGroupTrigger = exports.updateAuthMFAConfiguration = exports.updateAuthAdminQueriesWithExtMigration = exports.updateAuthWithoutTrigger = exports.updateAuthAddAdminQueries = exports.addAuthUserPoolOnlyNoOAuth = exports.addAuthIdentityPoolAndUserPoolWithOAuth = exports.addAuthUserPoolOnlyWithOAuth = exports.updateAuthAddUserGroups = exports.addAuthWithPreTokenGenerationTrigger = exports.addAuthWithMaxOptions = exports.addAuthWithGroupsAndAdminAPI = exports.addAuthWithGroups = exports.addAuthUserPoolOnly = exports.addAuthWithDefaultSocial = exports.addAuthWithDefaultSocial_v4_30 = exports.addAuthWithSignInSignOutUrl = exports.updateAuthRemoveRecaptchaTrigger = exports.addAuthWithRecaptchaTrigger = exports.updateAuthWithoutCustomTrigger = exports.updateAuthToRemoveFederation = exports.updateAuthSignInSignOutUrl = exports.addAuthWithCustomTrigger = exports.addAuthwithUserPoolGroupsViaAPIWithTrigger = exports.addAuthViaAPIWithTrigger = exports.addAuthWithEmailVerificationAndUserPoolGroupTriggers = exports.addAuthWithGroupTrigger = exports.removeAuthWithDefault = exports.runAmplifyAuthConsole = exports.addAuthWithDefault = void 0;
const lodash_1 = __importDefault(require("lodash"));
const __1 = require("..");
const addAuthWithDefault = (cwd, testingWithLatestCodebase = false) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, __1.nspawn)((0, __1.getCLIPath)(testingWithLatestCodebase), ['add', 'auth'], { cwd, stripColors: true })
...
function runAmplifyAuthConsole(cwd) {
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['auth', 'console'], { cwd, stripColors: true })
            .wait('Which console')
            .sendCarriageReturn()
...
exports.runAmplifyAuthConsole = runAmplifyAuthConsole;
function removeAuthWithDefault(cwd, testingWithLatestCodebase = false) {
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(testingWithLatestCodebase), ['remove', 'auth'], { cwd, stripColors: true })
...
exports.removeAuthWithDefault = removeAuthWithDefault;
function addAuthWithGroupTrigger(cwd) {
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
...
exports.addAuthWithGroupTrigger = addAuthWithGroupTrigger;
function addAuthWithEmailVerificationAndUserPoolGroupTriggers(cwd) {
    return __awaiter(this, void 0, void 0, function* () {
        yield (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration?')
            .sendCarriageReturn()
            .wait('How do you want users to be able to sign in')
            .sendKeyDown() // Email
...
exports.addAuthWithEmailVerificationAndUserPoolGroupTriggers = addAuthWithEmailVerificationAndUserPoolGroupTriggers;
const defaultOptions = {
    apiName: '\r',
    testingWithLatestCodebase: true,
    transformerVersion: 2,
};
function addAuthViaAPIWithTrigger(cwd, opts = {}) {
    const options = lodash_1.default.assign(defaultOptions, opts);
    return new Promise((resolve, reject) => {
...
exports.addAuthViaAPIWithTrigger = addAuthViaAPIWithTrigger;
function addAuthwithUserPoolGroupsViaAPIWithTrigger(cwd, opts = {}) {
    const options = lodash_1.default.assign(defaultOptions, opts);
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(options.testingWithLatestCodebase), ['add', 'api'], { cwd, stripColors: true })
            .wait('Select from one of the below mentioned services:')
...
exports.addAuthwithUserPoolGroupsViaAPIWithTrigger = addAuthwithUserPoolGroupsViaAPIWithTrigger;
function addAuthWithCustomTrigger(cwd, settings) {
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration?')
            .send(__1.KEY_DOWN_ARROW)
...
exports.addAuthWithCustomTrigger = addAuthWithCustomTrigger;
function updateAuthSignInSignOutUrl(cwd, settings) {
    var _a;
    const testingWithLatestCodebase = (_a = settings.testingWithLatestCodebase) !== null && _a !== void 0 ? _a : false;
    return new Promise((resolve, reject) => {
        var _a;
        const chain = (0, __1.nspawn)((0, __1.getCLIPath)(testingWithLatestCodebase), ['update', 'auth'], { cwd, stripColors: true });
        if (((_a = settings === null || settings === void 0 ? void 0 : settings.overrides) === null || _a === void 0 ? void 0 : _a.category) === 'auth') {
...
exports.updateAuthSignInSignOutUrl = updateAuthSignInSignOutUrl;
function updateAuthToRemoveFederation(cwd, settings) {
    var _a;
    const testingWithLatestCodebase = (_a = settings.testingWithLatestCodebase) !== null && _a !== void 0 ? _a : false;
    return new Promise((resolve, reject) => {
        var _a;
...
exports.updateAuthToRemoveFederation = updateAuthToRemoveFederation;
function updateAuthWithoutCustomTrigger(cwd, settings) {
    var _a;
    const testingWithLatestCodebase = (_a = settings.testingWithLatestCodebase) !== null && _a !== void 0 ? _a : false;
    return new Promise((resolve, reject) => {
        var _a;
...
exports.updateAuthWithoutCustomTrigger = updateAuthWithoutCustomTrigger;
function addAuthWithRecaptchaTrigger(cwd) {
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration?')
            .sendCarriageReturn()
...
exports.addAuthWithRecaptchaTrigger = addAuthWithRecaptchaTrigger;
function updateAuthRemoveRecaptchaTrigger(cwd, settings) {
    var _a;
    const testingWithLatestCodebase = (_a = settings.testingWithLatestCodebase) !== null && _a !== void 0 ? _a : false;
...
exports.updateAuthRemoveRecaptchaTrigger = updateAuthRemoveRecaptchaTrigger;
function addAuthWithSignInSignOutUrl(cwd, settings) {
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration?')
            .sendLine(__1.KEY_DOWN_ARROW)
            .sendCarriageReturn()
            .wait('How do you want users to be able to sign in?')
            .sendCarriageReturn()
            .wait('Do you want to configure advanced settings?')
...
exports.addAuthWithSignInSignOutUrl = addAuthWithSignInSignOutUrl;
function addAuthWithDefaultSocial_v4_30(cwd) {
    return new Promise((resolve, reject) => {
        const { FACEBOOK_APP_ID, FACEBOOK_APP_SECRET, GOOGLE_APP_ID, GOOGLE_APP_SECRET, AMAZON_APP_ID, AMAZON_APP_SECRET } = (0, __1.getSocialProviders)(true);
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration?')
            .send(__1.KEY_DOWN_ARROW)
            .sendCarriageReturn()
...
exports.addAuthWithDefaultSocial_v4_30 = addAuthWithDefaultSocial_v4_30;
function addAuthWithDefaultSocial(cwd) {
    return new Promise((resolve, reject) => {
        const { FACEBOOK_APP_ID, FACEBOOK_APP_SECRET, GOOGLE_APP_ID, GOOGLE_APP_SECRET, AMAZON_APP_ID, AMAZON_APP_SECRET, APPLE_APP_ID, APPLE_TEAM_ID, APPLE_KEY_ID, APPLE_PRIVATE_KEY, } = (0, __1.getSocialProviders)(true);
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration?')
            .send(__1.KEY_DOWN_ARROW)
            .sendCarriageReturn()
...
function addAuthUserPoolOnly(cwd) {
    return new Promise((resolve, reject) => {
        const { FACEBOOK_APP_ID, FACEBOOK_APP_SECRET, GOOGLE_APP_ID, GOOGLE_APP_SECRET, AMAZON_APP_ID, AMAZON_APP_SECRET, APPLE_APP_ID, APPLE_TEAM_ID, APPLE_KEY_ID, APPLE_PRIVATE_KEY, } = (0, __1.getSocialProviders)(true);
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration?')
...
exports.addAuthUserPoolOnly = addAuthUserPoolOnly;
// creates 2 groups: Admins, Users
function addAuthWithGroups(cwd) {
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration')
            .sendKeyDown(2)
...
exports.addAuthWithGroups = addAuthWithGroups;
// creates 2 groups: Admins, Users
function addAuthWithGroupsAndAdminAPI(cwd) {
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration')
            .sendKeyDown(2)
...
exports.addAuthWithGroupsAndAdminAPI = addAuthWithGroupsAndAdminAPI;
function addAuthWithMaxOptions(cwd, settings) {
    const { FACEBOOK_APP_ID, FACEBOOK_APP_SECRET, GOOGLE_APP_ID, GOOGLE_APP_SECRET, AMAZON_APP_ID, AMAZON_APP_SECRET, APPLE_APP_ID, APPLE_TEAM_ID, APPLE_KEY_ID, APPLE_PRIVATE_KEY, } = (0, __1.getSocialProviders)(true);
    return new Promise((resolve, reject) => {
        const chain = (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration?')
            .send(__1.KEY_DOWN_ARROW)
            .send(__1.KEY_DOWN_ARROW)
            .sendCarriageReturn()
...
exports.addAuthWithMaxOptions = addAuthWithMaxOptions;
//add default auth with pre token generation trigger
function addAuthWithPreTokenGenerationTrigger(projectDir) {
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd: projectDir, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration')
            .sendCarriageReturn()
            .wait('How do you want users to be able to sign in')
            .sendCarriageReturn()
            ...
            .sendCarriageReturn()
            .wait('Do you want to enable any of the following capabilities')
            .send(__1.KEY_UP_ARROW) //Override ID Token Claims
            .sendLine(' ')
...
exports.addAuthWithPreTokenGenerationTrigger = addAuthWithPreTokenGenerationTrigger;
function updateAuthAddUserGroups(projectDir, groupNames, settings) {
    ...
    return new Promise((resolve, reject) => {
        var _a;
        const chain = (0, __1.nspawn)((0, __1.getCLIPath)(testingWithLatestCodebase), ['update', 'auth'], { cwd: projectDir, stripColors: true });
        if (((_a = settings === null || settings === void 0 ? void 0 : settings.overrides) === null || _a === void 0 ? void 0 : _a.category) === 'auth') {
            chain.wait('A migration is needed to support latest updates on auth resources').sendConfirmYes();
        }
        chain
...
exports.updateAuthAddUserGroups = updateAuthAddUserGroups;
function addAuthUserPoolOnlyWithOAuth(cwd, settings) {
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration?')
            .sendKeyDown(2)
...
exports.addAuthUserPoolOnlyWithOAuth = addAuthUserPoolOnlyWithOAuth;
function addAuthIdentityPoolAndUserPoolWithOAuth(cwd, settings) {
    return new Promise((resolve, reject) => {
        const chain = (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration?')
            .sendKeyDown(2)
...
exports.addAuthIdentityPoolAndUserPoolWithOAuth = addAuthIdentityPoolAndUserPoolWithOAuth;
function addAuthUserPoolOnlyNoOAuth(cwd, settings) {
    return new Promise((resolve, reject) => {
        (0, __1.nspawn)((0, __1.getCLIPath)(), ['add', 'auth'], { cwd, stripColors: true })
            .wait('Do you want to use the default authentication and security configuration?')
            .sendKeyDown(2)
...
exports.addAuthUserPoolOnlyNoOAuth = addAuthUserPoolOnlyNoOAuth;
function updateAuthAddAdminQueries(projectDir, groupName = 'adminQueriesGroup', settings = {}) {
    var _a;
    const testingWithLatestCodebase = (_a = settings.testingWithLatestCodebase) !== null && _a !== void 0 ? _a : false;
    return new Promise((resolve, reject) => {
        var _a;
...
exports.updateAuthAddAdminQueries = updateAuthAddAdminQueries;
function updateAuthWithoutTrigger(cwd, settings) {
    var _a;
    const testingWithLatestCodebase = (_a = settings.testingWithLatestCodebase) !== null && _a !== void 0 ? _a : false;
    return new Promise((resolve, reject) => {
        var _a;
...
exports.updateAuthWithoutTrigger = updateAuthWithoutTrigger;
function updateAuthAdminQueriesWithExtMigration(cwd, settings) {
    return (0, __1.nspawn)((0, __1.getCLIPath)(settings.testingWithLatestCodebase), ['update', 'auth'], { cwd, stripColors: true })
...
exports.updateAuthAdminQueriesWithExtMigration = updateAuthAdminQueriesWithExtMigration;
function updateAuthMFAConfiguration(projectDir, settings = {}) {
    return (0, __1.nspawn)((0, __1.getCLIPath)(settings.testingWithLatestCodebase), ['update', 'auth'], { cwd: projectDir, stripColors: true })
        .wait('What do you want to do?')
        .send(__1.KEY_DOWN_ARROW)
...
exports.updateAuthMFAConfiguration = updateAuthMFAConfiguration;
function updateAuthWithGroupTrigger(cwd) {
    return (0, __1.nspawn)((0, __1.getCLIPath)(), ['update', 'auth'], { cwd, stripColors: true })
        .wait('What do you want to do?')
        .send(__1.KEY_DOWN_ARROW)
        .send(__1.KEY_DOWN_ARROW)
        .sendCarriageReturn()
...
exports.updateAuthWithGroupTrigger = updateAuthWithGroupTrigger;
