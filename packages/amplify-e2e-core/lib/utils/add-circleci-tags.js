...
exports.sanitizeTagValue = exports.addCircleCITags = void 0;
const amplify_cli_core_1 = require("amplify-cli-core");
const addCircleCITags = (projectPath) => {
    if (process.env && process.env['CIRCLECI']) {
        const tags = amplify_cli_core_1.stateManager.getProjectTags(projectPath);
        const addTagIfNotExist = (key, value) => {
...
exports.addCircleCITags = addCircleCITags;
function sanitizeTagValue(value) {
    return value.replace(/[^ a-z0-9_.:/=+\-@]/gi, '');
}
exports.sanitizeTagValue = sanitizeTagValue;
//# sourceMappingURL=add-circleci-tags.js.map