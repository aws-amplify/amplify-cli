...
export function addAuthWithDefaultSocial(cwd: string, settings: any): Promise<void> {
  return new Promise((resolve, reject) => {
    ...
    spawn(getCLIPath(), ['add', 'auth'], { cwd, stripColors: true })
      ...
      .send(AMAZON_APP_SECRET)
      .sendCarriageReturn()
      .wait('Enter your Apple Services ID for your OAuth flow:')
      .send(APPLE_APP_ID)
      .sendCarriageReturn()
      .wait('Enter your Apple Team ID for your OAuth flow:')
      .send(APPLE_TEAM_ID)
      .sendCarriageReturn()
      .wait('Enter your Apple Key ID for your OAuth flow:')
      .send(APPLE_KEY_ID)
      .sendCarriageReturn()
      .wait('Enter your Apple Private Key for your OAuth flow:')
