...
import { AddS3ServiceConfiguration, AddStorageRequest, CrudOperation } from 'amplify-headless-interface';
...
async function createS3StorageArtifacts(context: $TSContext, storageRequest: AddStorageRequest) {
  ...
  }: { serviceConfiguration: AddS3ServiceConfiguration } = storageRequest;
