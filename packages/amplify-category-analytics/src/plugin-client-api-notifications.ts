 ...
 */
export const invokeNotificationsAPIRecursiveRemoveApp = async (
  context: $TSContext,
  appName: string,
): Promise<IPluginAPIResponse> => (await context.amplify.invokePluginMethod(context,
 ...
 */
export const invokeNotificationsAPIGetAvailableChannelNames = async (
  context: $TSContext,
): Promise<string[]> => (await context.amplify.invokePluginMethod(context, AmplifyCategories.NOTIFICATIONS, undefined,
