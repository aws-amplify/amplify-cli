...
export interface FunctionWalkthroughProvider {
    ...
    updateWalkthrough: (context: $TSContext, resourceToUpdate?: string, params?: Partial<FunctionParameters>) => Promise<Partial<FunctionParameters>>;
    migrate?: Function;
...
export interface LayerWalkthroughProvider {
    ...
    updateWalkthrough: (context: $TSContext, resourceToUpdate?: string, params?: Partial<LayerParameters>) => Promise<{
        parameters: Partial<LayerParameters>;
        resourceUpdated: boolean;
    }>;
}
//# sourceMappingURL=supportedServicesType.d.ts.map