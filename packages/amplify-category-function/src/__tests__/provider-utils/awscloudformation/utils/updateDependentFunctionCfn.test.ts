import { updateMissingDependencyFunctionsCfn } from '../../../../provider-utils/awscloudformation/utils/updateDependentFunctionCfn';
...
test('update dependent functions', async () => {
  ...
  await updateMissingDependencyFunctionsCfn(
