 ...
 */
export async function createWalkthrough(context: any, templateParameters: Partial<FunctionParameters>): Promise<Partial<FunctionParameters>> {
...
export async function updateWalkthrough(context: any, lambdaToUpdate: any) {
