...
//
// @public (undocumented)
export const askExecRolePermissionsQuestions: (
  context: $TSContext,
  resourceNameToUpdate: string,
  currentPermissionMap?: any,
  currentEnvMap?: any,
  category?: string,
  serviceName?: string,
...
// @public (undocumented)
export function lambdasWithApiDependency(
  context: $TSContext,
...
// @public (undocumented)
export function updateDependentFunctionsCfn(
  context: $TSContext,
