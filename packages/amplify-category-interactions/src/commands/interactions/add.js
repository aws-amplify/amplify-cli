...
module.exports = {
  name: subcommand,
  run: async (context) => {
    context.print.warning('The interactions category cannot been added.');

    return context.print.info(
      `
      Amazon Lex V1 is reaching end of life on September 15, 2025 and is no longer allowing the creating of new bots as of March 31, 2025. 
      The interactions category will not migrate to Lex V2.
