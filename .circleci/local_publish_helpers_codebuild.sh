...
function verifyPkgCli {
    ...
    verifySinglePkg "amplify-pkg-linux-x64" "amplify-pkg-linux-x64.tgz" $((820 * 1024 * 1024))
    verifySinglePkg "amplify-pkg-macos-x64" "amplify-pkg-macos-x64.tgz" $((820 * 1024 * 1024))
