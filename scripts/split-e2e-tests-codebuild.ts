...
const TEST_EXCLUSIONS: { l: string[]; w: string[] } = {
  l: [
    ...
    'src/__tests__/auth_2f.test.ts',
    'src/__tests__/auth_2d.test.ts',
    'src/__tests__/auth_2b.test.ts',
    'src/__tests__/auth_2a.test.ts',
    'src/__tests__/analytics-pinpoint-js.test.ts',
    'src/__tests__/analytics-pinpoint-flutter.test.ts',
    'src/__tests__/analytics-kinesis.test.ts',
    ...
    'src/__tests__/global_sandbox-c.test.ts',
    ...
    'src/__tests__/graphql-v2/custom-transformers.test.ts',
    'src/__tests__/with-babel-config.test.ts',
    'src/__tests__/notifications-in-app-messaging-env-2.test.ts',
    'src/__tests__/notifications-fcm.test.ts',
    'src/__tests__/notifications-apns.test.ts',
    'src/__tests__/init_b.test.ts',
    'src/__tests__/container-hosting.test.ts',
    'src/__tests__/auth_10.test.ts',
    'src/__tests__/init_f.test.ts',
    'src/__tests__/init_d.test.ts',
    'src/__tests__/amplify-configure.test.ts',
    'src/__tests__/layer-4.test.ts',
    'src/__tests__/init_c.test.ts',
    'src/__tests__/configure-project.test.ts',
    'src/__tests__/auth_5d.test.ts',
    'src/__tests__/auth_2c.test.ts',
    'src/__tests__/auth_2e.test.ts',
    'src/__tests__/aws-exports/js-frontend-config.test.ts',
    'src/__tests__/containers-api-1.test.ts',
