...
| `Cfn`                          | `cfn.ts`                                   | Shared CloudFormation client wrapper. Handles update, refactor, changeset, delete, describe, and template fetch operations. Tracks update claims to prevent duplicate stack updates across refactorers. |
