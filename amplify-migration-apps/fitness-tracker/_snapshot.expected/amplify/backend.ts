...
const gen1nutritionapiApi = RestApi.fromRestApiAttributes(nutritionapiStack, "Gen1nutritionapiApi", {
    restApiId: "55iigxjh1f",
    rootResourceId: "4faao8kuha"
});
const gen1nutritionapiPolicy = new Policy(nutritionapiStack, "Gen1nutritionapiPolicy", {
    statements: [new PolicyStatement({
            actions: ["execute-api:Invoke"],
            resources: [`${gen1nutritionapiApi.arnForExecuteApi("POST", "/*")}`, `${gen1nutritionapiApi.arnForExecuteApi("GET", "/*")}`, `${gen1nutritionapiApi.arnForExecuteApi("PUT", "/*")}`, `${gen1nutritionapiApi.arnForExecuteApi("DELETE", "/*")}`]
        })]
});
...
backend.auth.resources.authenticatedUserIamRole.attachInlinePolicy(new Policy(nutritionapiStack, "nutritionlogAuthPolicy", {
    statements: [new PolicyStatement({
            actions: ["execute-api:Invoke"],
            resources: [nutritionapiApi.arnForExecuteApi("POST", "/nutrition/log"), nutritionapiApi.arnForExecuteApi("POST", "/nutrition/log/*"), nutritionapiApi.arnForExecuteApi("GET", "/nutrition/log"), nutritionapiApi.arnForExecuteApi("GET", "/nutrition/log/*"), nutritionapiApi.arnForExecuteApi("PUT", "/nutrition/log"), nutritionapiApi.arnForExecuteApi("PUT", "/nutrition/log/*"), nutritionapiApi.arnForExecuteApi("DELETE", "/nutrition/log"), nutritionapiApi.arnForExecuteApi("DELETE", "/nutrition/log/*")]
        })]
}));
// /nutrition/log - Admin group only
backend.auth.resources.groups["Admin"].role.attachInlinePolicy(new Policy(nutritionapiStack, "nutritionlogAdminPolicy", {
    statements: [new PolicyStatement({
            actions: ["execute-api:Invoke"],
            resources: [nutritionapiApi.arnForExecuteApi("POST", "/nutrition/log"), nutritionapiApi.arnForExecuteApi("POST", "/nutrition/log/*"), nutritionapiApi.arnForExecuteApi("GET", "/nutrition/log"), nutritionapiApi.arnForExecuteApi("GET", "/nutrition/log/*"), nutritionapiApi.arnForExecuteApi("PUT", "/nutrition/log"), nutritionapiApi.arnForExecuteApi("PUT", "/nutrition/log/*"), nutritionapiApi.arnForExecuteApi("DELETE", "/nutrition/log"), nutritionapiApi.arnForExecuteApi("DELETE", "/nutrition/log/*")]
        })]
...
const gen1adminapiApi = RestApi.fromRestApiAttributes(adminapiStack, "Gen1adminapiApi", {
    restApiId: "ork0ggyoxc",
    rootResourceId: "kwlwc6x5vd"
});
...
backend.auth.resources.groups["Admin"].role.attachInlinePolicy(new Policy(adminapiStack, "adminAdminPolicy", {
    statements: [new PolicyStatement({
            actions: ["execute-api:Invoke"],
...
backend.admin.addEnvironment("AUTH_FITNESSTRACKER969D5A9E969D5A9E_USERPOOLID", backend.auth.resources.userPool.userPoolId);
