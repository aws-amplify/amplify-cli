...
type Query {
  ...
  commentsByProductId(productId: ID!, sortDirection: ModelSortDirection, filter: ModelCommentFilterInput, limit: Int, nextToken: String): ModelCommentConnection @aws_iam @aws_cognito_user_pools
  checkLowStock: LowStockResponse @aws_api_key @aws_iam
}
...
type Subscription {
  ...
  onCreateUser(filter: ModelSubscriptionUserFilterInput, id: String): User @aws_subscribe(mutations: ["createUser"]) @aws_iam @aws_cognito_user_pools
  onUpdateUser(filter: ModelSubscriptionUserFilterInput, id: String): User @aws_subscribe(mutations: ["updateUser"]) @aws_iam @aws_cognito_user_pools
  onDeleteUser(filter: ModelSubscriptionUserFilterInput, id: String): User @aws_subscribe(mutations: ["deleteUser"]) @aws_iam @aws_cognito_user_pools
  onCreateComment(filter: ModelSubscriptionCommentFilterInput, authorId: String): Comment @aws_subscribe(mutations: ["createComment"]) @aws_iam @aws_cognito_user_pools
  onUpdateComment(filter: ModelSubscriptionCommentFilterInput, authorId: String): Comment @aws_subscribe(mutations: ["updateComment"]) @aws_iam @aws_cognito_user_pools
  onDeleteComment(filter: ModelSubscriptionCommentFilterInput, authorId: String): Comment @aws_subscribe(mutations: ["deleteComment"]) @aws_iam @aws_cognito_user_pools
}
...
input ModelProductFilterInput {
  id: ModelIDInput
  serialno: ModelIntInput
  engword: ModelStringInput
  ...
  imageUploadedAt: ModelStringInput
...
input ModelSubscriptionCommentFilterInput {
  ...
  authorName: ModelSubscriptionStringInput
