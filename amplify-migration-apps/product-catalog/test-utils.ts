...
export const CATEGORIES = ['Electronics', 'Clothing', 'Books', 'Home & Garden', 'Sports', 'Toys', 'Other'];
...
export async function authenticateUser(testUser: TestUserCredentials): Promise<boolean> {
  console.log('\n🔐 Authenticating user...');
  try {
    await signIn({
...
export async function testListProducts(): Promise<string | null> {
...
export async function testGetProduct(id: string): Promise<void> {
...
export async function testListUsers(): Promise<string | null> {
  console.log('\n👥 Testing listUsers...');
  const client = getAuthClient();
...
export async function testGetUser(id: string): Promise<void> {
...
export async function testListComments(): Promise<string | null> {
...
export async function testCommentsByProductId(productId: string): Promise<void> {
...
export async function testCheckLowStock(): Promise<void> {
...
export async function testCreateProduct(): Promise<string | null> {
...
export async function testUpdateProduct(productId: string): Promise<void> {
...
export async function testDeleteProduct(productId: string): Promise<void> {
...
export async function testCreateUser(): Promise<string | null> {
  console.log('\n🆕 Testing createUser...');
  const client = getAuthClient();
...
export async function testUpdateUserRole(userId: string, newRole: UserRole): Promise<void> {
...
export async function testDeleteUser(userId: string): Promise<void> {
...
export async function testCreateComment(productId: string): Promise<string | null> {
...
export async function testUpdateComment(commentId: string): Promise<void> {
...
export async function testDeleteComment(commentId: string): Promise<void> {
...
export async function testUploadProductImage(productId?: string): Promise<string | null> {
...
export async function testGetImageUrl(imageKey: string): Promise<string | null> {
...
export async function testCreateProductWithImage(): Promise<{ productId: string | null; imageKey: string | null }> {
...
export async function testRoleBasedPermissions(): Promise<void> {
...
export async function testProductFiltering(): Promise<void> {
...
export async function testLowStockReportGeneration(): Promise<void> {
...
export async function runQueryTests(
  runTest: <T>(name: string, testFn: () => Promise<T>) => Promise<T | null>,
): Promise<{ productId: string | null; userId: string | null }> {
  console.log('\n' + '='.repeat(60));
...
export async function runProductMutationTests(
  runTest: <T>(name: string, testFn: () => Promise<T>) => Promise<T | null>,
): Promise<string | null> {
  console.log('\n' + '='.repeat(60));
...
export async function runUserMutationTests(runTest: <T>(name: string, testFn: () => Promise<T>) => Promise<T | null>): Promise<void> {
  console.log('\n' + '='.repeat(60));
...
export async function runCommentMutationTests(
  productId: string,
  runTest: <T>(name: string, testFn: () => Promise<T>) => Promise<T | null>,
): Promise<void> {
  console.log('\n' + '='.repeat(60));
...
export async function runStorageTests(runTest: <T>(name: string, testFn: () => Promise<T>) => Promise<T | null>): Promise<void> {
  console.log('\n' + '='.repeat(60));
...
export async function runRBACTests(runTest: <T>(name: string, testFn: () => Promise<T>) => Promise<T | null>): Promise<void> {
  console.log('\n' + '='.repeat(60));
...
export async function runBusinessLogicTests(runTest: <T>(name: string, testFn: () => Promise<T>) => Promise<T | null>): Promise<void> {
  console.log('\n' + '='.repeat(60));
