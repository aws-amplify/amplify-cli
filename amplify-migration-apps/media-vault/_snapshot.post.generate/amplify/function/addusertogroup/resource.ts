...
export function applyEscapeHatches(backend: Backend) {
  ...
  backend.addusertogroup.addEnvironment('AUTH_MEDIAVAULT1F08412D_USERPOOLID', backend.auth.resources.userPool.userPoolId);
  new aws_iam.Policy(backend.addusertogroup.resources.lambda, 'UnmappedCognitoActionsPolicy', {
    statements: [
