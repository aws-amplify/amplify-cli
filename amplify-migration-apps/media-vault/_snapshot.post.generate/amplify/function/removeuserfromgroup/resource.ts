...
export function applyEscapeHatches(backend: Backend) {
  ...
  backend.removeuserfromgroup.addEnvironment('AUTH_MEDIAVAULT1F08412D_USERPOOLID', backend.auth.resources.userPool.userPoolId);
  new aws_iam.Policy(backend.removeuserfromgroup.resources.lambda, 'UnmappedCognitoActionsPolicy', {
    statements: [
