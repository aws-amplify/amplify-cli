...
export class geostoreLocatorSearch extends Construct {
  ...
  public constructor(scope: Construct, id: string, props: geostoreLocatorSearchProps) {
    super(scope, id);
    ...
    // Resources
    const customPlaceIndexLambdaServiceRoleFd2f3c9d = new iam.CfnRole(this, 'CustomPlaceIndexLambdaServiceRoleFD2F3C9D', {
    ...
    const customPlaceIndexLambdaServiceRoleDefaultPolicy818068B1 = new iam.CfnPolicy(
      this,
        ...
        policyDocument: {
          Statement: [
            ...
            },
            {
              ...
              }:place-index/${[props.indexName!, props.branchName!].join('-')}`,
            },
          ],
          Version: '2012-10-17',
        },
    ...
    const customPlaceIndexLambda79813Bb9 = new lambda.CfnFunction(this, 'CustomPlaceIndexLambda79813BB9', {
      code: {
        zipFile:
    ...
    customPlaceIndexLambda79813Bb9.addDependency(customPlaceIndexLambdaServiceRoleDefaultPolicy818068B1);
    customPlaceIndexLambda79813Bb9.addDependency(customPlaceIndexLambdaServiceRoleFd2f3c9d);
    ...
    customPlaceIndex.addPropertyOverride('indexName', [props.indexName!, props.branchName!].join('-'));
    ...
    const placeIndexPolicy = new iam.CfnPolicy(this, 'PlaceIndexPolicy', {
      ...
      policyName: [[props.indexName!, props.branchName!].join('-'), 'Policy'].join(''),
